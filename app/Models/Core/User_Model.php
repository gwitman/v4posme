...
class User_Model extends Model  {
   ...
   function get_rowByExistNickname($nickname){
		$db 	= db_connect();
		$sql = "";
		$sql = sprintf("select companyID,branchID,userID,nickname,password,email,createdOn,createdBy,employeeID");
   ...
   function get_rowByPK($companyID,$branchID,$userID){
		$db 	= db_connect();
		$sql = "";
		$sql = sprintf("select companyID,branchID,userID,nickname,password,email,createdOn,isActive,createdBy,employeeID");
		$sql = $sql.sprintf(" from tb_user");
