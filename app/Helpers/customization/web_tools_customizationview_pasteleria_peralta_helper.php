    ...
    $bloomoon = array(
		...
		<script>
			$(document).ready(function(){		
				...
				$('#btnOptionPago').parent().appendTo('#divPanelFacturaSideBarComandos');
				...
				$('#btnPrinter').parent().clone(true, true).appendTo('#divPanelFacturaSideBar');
				$('#btnNew').parent().appendTo('#rowBotoneraFacturaFila1');
				$('#btnDelete').parent().appendTo('#rowBotoneraFacturaFila1');
				$('#btnOptionPago').parent().clone(true, true).appendTo('#rowBotoneraFacturaFila4');
				$('#btnNew').parent().clone(true, true).appendTo('#divPanelFacturaSideBar');
