<?php
function helper_reporte80mmTransactionMasterLicoreriaCentral(
    $titulo,
    $objCompany,
    $objParameterLogo,
...
)
{
    ...
    $transactionNumber 	= str_replace("FAC", "ATK", $objTransactionMastser->transactionNumber);
	$transactionNumber 	= str_replace("PRF", "RTK", $transactionNumber);
