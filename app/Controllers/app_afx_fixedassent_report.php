...
class app_afx_fixedassent_report extends _BaseController {
	...
	function index($dataViewID = null){	
		try{ 
			...
			$dataSession["head"]			= /*--inicio view*/ view('app_afx_fixedassent_report/view_head');//--finview
			$dataSession["body"]			= /*--inicio view*/ view('app_afx_fixedassent_report/view_body',$dataMenu);//--finview
			$dataSession["script"]			= /*--inicio view*/ view('app_afx_fixedassent_report/view_script');//--finview
			$dataSession["footer"]			= "";			
