...
class app_cxc_customer extends _BaseController {
	...
	try{ 
			...
			$dataSession["notification"]	= $this->core_web_error->get_error($dataSession["user"]->userID);
			$dataSession["message"]			= $this->core_web_notification->get_message();
			$dataSession["head"]			= /*--inicio view*/ view('app_cxc_customer/list_head');//--finview
			$dataSession["footer"]			= /*--inicio view*/ view('app_cxc_customer/list_footer');//--finview
			$dataSession["body"]			= $dataViewRender; 
			$dataSession["script"]			= /*--inicio view*/ view('app_cxc_customer/list_script');//--finview
