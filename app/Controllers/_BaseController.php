...
abstract class _BaseController extends Controller
{
    ...
    protected $helpers = [
        ...
        'customization/web_tools_customizationview_farma_byb_helper',
		...
		'customization/web_tools_customizationview_njgym_helper',
    ];
	...
	protected $Customer_Conversation_Model;
    ...
    public function initController(RequestInterface $request, ResponseInterface $response, LoggerInterface $logger)
    {
		...
		$this->Customer_Conversation_Model = new Customer_Conversation_Model();
