...
class app_purchase_internalpurchaserequest extends _BaseController {
	...
	function insertElement($dataSession){
		try{
			...
			$objTM["amount"] 						= 0;
			$objTM["isApplied"] 					= /*inicio get post*/ $this->request->getPost("txtIsApplied");
			...
			if($db->transStatus() !== false){
				...
				$this->response->redirect(base_url()."/".'app_purchase_internalpurchaserequest/edit/companyID/'.$companyID."/transactionID/".$objTM["transactionID"]."/transactionMasterID/".$transactionMasterID);
			}
			else{
				$db->transRollback();						
				$this->core_web_notification->set_message(true,$this->db->_error_message());
				$this->response->redirect(base_url()."/".'app_purchase_internalpurchaserequest/add');	
			}
	...
	function updateElement($dataSession){
		try{
			...
			if($db->transStatus() !== false){
				$db->transCommit();						
				$this->core_web_notification->set_message(false,SUCCESS);
				$this->response->redirect(base_url()."/".'app_purchase_internalpurchaserequest/edit/companyID/'.$companyID."/transactionID/".$transactionID."/transactionMasterID/".$transactionMasterID);
			}
			else{
				$db->transRollback();						
				$this->core_web_notification->set_message(true,$this->db->_error_message());
	...
	function edit(){
		try{ 
			...
			$dataSession["head"]			= /*--inicio view*/ view('app_purchase_internalpurchaserequest/edit_head',$datView);//--finview
			$dataSession["body"]			= /*--inicio view*/ view('app_purchase_internalpurchaserequest/edit_body',$datView);//--finview
			$dataSession["script"]			= /*--inicio view*/ view('app_purchase_internalpurchaserequest/edit_script',$datView);//--finview
			$dataSession["footer"]			= "";				
	...
	function add(){
		try{ 
			...
			$dataSession["notification"]		= $this->core_web_error->get_error($dataSession["user"]->userID);
			$dataSession["message"]				= $this->core_web_notification->get_message();
			$dataSession["head"]				= /*--inicio view*/ view('app_purchase_internalpurchaserequest/news_head',$dataView);//--finview
			$dataSession["body"]				= /*--inicio view*/ view('app_purchase_internalpurchaserequest/news_body',$dataView);//--finview
			$dataSession["script"]				= /*--inicio view*/ view('app_purchase_internalpurchaserequest/news_script',$dataView);//--finview
			$dataSession["footer"]				= "";
			return view("core_masterpage/default_masterpage",$dataSession);//--finview-r
	...
	try{
			...
			$dataSession["notification"]	= $this->core_web_error->get_error($dataSession["user"]->userID);
			$dataSession["message"]			= $this->core_web_notification->get_message();
			$dataSession["head"]			= /*--inicio view*/ view('app_purchase_internalpurchaserequest/list_head');//--finview
			$dataSession["footer"]			= /*--inicio view*/ view('app_purchase_internalpurchaserequest/list_footer');//--finview
			$dataSession["body"]			= $dataViewRender; 
			$dataSession["script"]			= /*--inicio view*/ view('app_purchase_internalpurchaserequest/list_script');//--finview
