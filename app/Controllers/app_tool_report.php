...
class app_tool_report extends _BaseController {
	...
	{	
		try{ 
			...
			$dataSession["head"]			= /*--inicio view*/ view('app_tool_report/view_head');//--finview
			$dataSession["body"]			= /*--inicio view*/ view('app_tool_report/view_body',$dataMenu);//--finview
			$dataSession["script"]			= /*--inicio view*/ view('app_tool_report/view_script');//--finview
			$dataSession["footer"]			= "";			
