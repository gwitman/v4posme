        ...
        try {
            ...
            if ($this->core_web_workflow->validateWorkflowStage("tb_transaction_master_fixedassent_input", "statusID", $objTMNew["statusID"], COMMAND_APLICABLE, $companyID, $branchID, $roleID)) {
                ...
                foreach ($objListFixedAssets as $asset) {
                    ...
                    $objWorkflowStage                               = $this->core_web_workflow->getWorkflowStageTargetBySource($transactionID, $companyID, $objTM->transactionCausalID, "tb_fixed_assent", $objAsset->statusID, "tb_transaction_master_fixedassent_input");
                ...
                $objWorkflowStage                               = $this->core_web_workflow->getWorkflowStageTargetBySource($transactionID, $companyID, $objTM->transactionCausalID, "tb_transaction_master_fixedassent_input", $objTMNew["statusID"], "tb_fixed_assent");
