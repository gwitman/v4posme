...
class app_purchase_purchaseorden extends _BaseController {
	...
	function insertElement($dataSession){
		try{
			...
			if($db->transStatus() !== false){
				...
				$this->response->redirect(base_url()."/".'app_purchase_purchaseorden/edit/companyID/'.$companyID."/transactionID/".$objTM["transactionID"]."/transactionMasterID/".$transactionMasterID);
			}
			else{
				$db->transRollback();						
				$this->core_web_notification->set_message(true,$this->db->_error_message());
				$this->response->redirect(base_url()."/".'app_purchase_purchaseorden/add');	
			}
	...
	function updateElement($dataSession){
		try{
			...
			if($db->transStatus() !== false){
				$db->transCommit();						
				$this->core_web_notification->set_message(false,SUCCESS);
				$this->response->redirect(base_url()."/".'app_purchase_purchaseorden/edit/companyID/'.$companyID."/transactionID/".$transactionID."/transactionMasterID/".$transactionMasterID);
			}
			else{
				$db->transRollback();						
				$this->core_web_notification->set_message(true,$this->db->_error_message());
	...
	function edit(){
		try{ 
			...
			$dataSession["head"]			= /*--inicio view*/ view('app_purchase_purchaseorden/edit_head',$datView);//--finview
			$dataSession["body"]			= /*--inicio view*/ view('app_purchase_purchaseorden/edit_body',$datView);//--finview
			$dataSession["script"]			= /*--inicio view*/ view('app_purchase_purchaseorden/edit_script',$datView);//--finview
			$dataSession["footer"]			= "";				
	...
	function add(){
		try{ 
			...
			$dataSession["notification"]		= $this->core_web_error->get_error($dataSession["user"]->userID);
			$dataSession["message"]				= $this->core_web_notification->get_message();
			$dataSession["head"]				= /*--inicio view*/ view('app_purchase_purchaseorden/news_head',$dataView);//--finview
			$dataSession["body"]				= /*--inicio view*/ view('app_purchase_purchaseorden/news_body',$dataView);//--finview
			$dataSession["script"]				= /*--inicio view*/ view('app_purchase_purchaseorden/news_script',$dataView);//--finview
			$dataSession["footer"]				= "";
			return view("core_masterpage/default_masterpage",$dataSession);//--finview-r
	...
	try{
			...
			$dataSession["notification"]	= $this->core_web_error->get_error($dataSession["user"]->userID);
			$dataSession["message"]			= $this->core_web_notification->get_message();
			$dataSession["head"]			= /*--inicio view*/ view('app_purchase_purchaseorden/list_head');//--finview
			$dataSession["footer"]			= /*--inicio view*/ view('app_purchase_purchaseorden/list_footer');//--finview
			$dataSession["body"]			= $dataViewRender; 
			$dataSession["script"]			= /*--inicio view*/ view('app_purchase_purchaseorden/list_script');//--finview
