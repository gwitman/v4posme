...
class app_lab_examen extends _BaseController 
{
    ...
    function edit(){
        try{
			...
			$dataView["objListIndicadores"]			= $this->Public_Catalog_Detail_Model->asObject()->where("publicCatalogID",$objPublicCatalogIndicadores[0]->publicCatalogID)->where( "isActive",1)->orderBy('sequence', 'ASC')->findAll();
