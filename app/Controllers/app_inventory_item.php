...
class app_inventory_item extends _BaseController
{
    ...
    public function edit()
    {
        try {
            ...
            //Obtener Informacion
            $dataView["objRolName"]                    = $dataSession["role"]->name;
    ...
    public function save($method, $item, $dataSession)
    {
        ...
        try {
            ...
            if ($method == "new") {
                ...
                $objListCatalogItemSKUPrice          = /*inicio get post*/$this->request->getPost("txtDetailSkuPrecio");
                $objListCatalogItemSKUPredeterminado = /*inicio get post*/$this->request->getPost("txtDetailSkuDefault");
    ...
    public function popup_add_concept()
    {
    ...
    public function popup_add_renderimg($companyID = "", $componentID = "", $itemID = "")
    {
