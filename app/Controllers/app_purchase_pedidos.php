...
class app_purchase_pedidos extends _BaseController {
	...
	function viewPrinterFormatoA4(){
		try{ 
			...
			if($objParameterShowLinkDownload == "true")
			{
				...
				$path        = "./resource/file_company/company_".$companyID."/component_97/component_item_".$transactionMasterID."/".$fileNamePut;
				...
				echo "<a 
					href='".base_url()."/resource/file_company/company_".$companyID."/component_97/component_item_".$transactionMasterID."/".
	...
	function viewRegisterFormatoPaginaTicket(){
		...
		try{ 
			...
			$datView["objStage"]					= $this->core_web_workflow->getWorkflowStage("tb_transaction_master_workshop_pedido","statusID",$datView["objTM"]->statusID,$companyID,$branchID,$roleID);
