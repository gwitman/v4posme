<script>	 				
	...
	$(document).ready(function(){
		...
		$(document).on("click","#btnAcept",function(){
				...
				$( "#form-new-account-type" ).attr("action","<?php echo base_url(); ?>/app_cxc_creditline/save/edit");
		...
		$(document).on("click","#btnDelete",function(){							
			fnShowConfirm("Confirmar..","Desea eliminar este Registro...",function(){
				...
				$.ajax({									
					...
					data 		: {companyID : <?php echo $objCreditLine->companyID;?>, creditLineID : <?php echo $objCreditLine->creditLineID;?>  },
					success:function(data){
						...
						if(data.error){
							...
							window.location = "<?php echo base_url(); ?>/app_cxc_creditline/index";
						}
					},
