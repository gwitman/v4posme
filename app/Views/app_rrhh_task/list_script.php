<script>
	...
	$(document).ready(function(){	
		...
		$(document).on("click","#btnViewKanba",function(){

			window.location = "<?php echo base_url(); ?>/app_rrhh_task/indexKanba";
		});		
		...
		$(document).on("click","#btnSearchTransaction",function(){
					...
					$.ajax({									
						...
						url  		: "<?php echo base_url(); ?>/app_rrhh_task/searchTransactionMaster",
						...
						success:function(data){
							...
							if(data.error){
								...
								window.location = "<?php echo base_url(); ?>/app_rrhh_task/edit/companyID/"+data.companyID+"/transactionID/"+data.transactionID+"/transactionMasterID/"+data.transactionMasterID;
		...
		$(document).on("click","#btnNuevo",function(){
			...
			window.location	= "<?php echo base_url(); ?>/app_rrhh_task/add";
	...
	function fn_aceptCallback(data){
			...
			window.location = "../../app_rrhh_task/index/"+dataViewID;   
