    ...
    <div id="email" class="col-lg-12">
        ...
        <div class="email-bar" style="border-left:1px solid #c9c9c9">
            <div class="btn-group pull-right">
                <a href="<?= base_url(); ?>/app_tools_endorsements/index" id="btnBack" class="btn btn-inverse" ><i class="icon16 i-rotate"></i> Atras</a>
                <a href="#" id="btnPrint" class="btn btn-primary" ><i class="icon16 i-print"></i> Imprimir</a>
                <a href="<?= base_url(); ?>/app_tools_endorsements/add" class="btn btn-warning" id="btnNuevo"><i class="icon16 i-checkmark-4"></i>Nuevo</a>
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                ...
                <h4>ENDOSO:#<span class="invoice-num"><?= $objTransactionMaster->transactionNumber ?></span></h4>
            </div>
            ...
            <form id="form-new-endoso" name="form-new-endoso" class="form-horizontal" role="form">
                ...
                <input type="hidden" name="txtTransactionIDEndoso" value="<?= $objTransactionMaster->transactionID; ?>">
                        ...
                        <div class="tab-pane fade in active" id="home">
                                    ...
                                    <select class="select2" id="txtStatusID" name="txtStatusID">
                                        ...
                                        if (isset($objListWorkflowStage))
                                            foreach($objListWorkflowStage as $tr){
                                                if ($tr->workflowStageID == $objTransactionMaster->statusID)
                                                    echo '<option selected value="'.$tr->workflowStageID.'">'.$tr->name.'</option>';
                                                else
                                    ...
                                    <select class="select2" name="txtTransactionID" id="txtTransactionID">
                                        ...
                                        if (isset($tipoTransaccion))
                                            foreach($tipoTransaccion as $tr){
                                                if ($tr->transactionID == $objTransactionMaster->reference1)
                                                    echo '<option selected value="'.$tr->transactionID.'">'.$tr->name.'</option>';
                                                else
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-lg-8">
                                    <input type="hidden" id="txtTransactionNumber" name="txtTransactionNumber" value="<?= $objTransactionMasterReference->transactionReferenceNumber ?>" />
                                    <input type="hidden" id="txtTransactionMasterIDEndoso" name="txtTransactionMasterIDEndoso" value="<?= $objTransactionMasterReference->reference1 ?>" />
                                    <input class="form-control" readonly id="txtTransactionNumberDescription" type="text" value="<?= $objTransactionMasterReference->transactionReferenceNumber ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input class="form-control" type="text" name="txtComentario" id="txtComentario" placeholder="Escriba el motivo del endoso" value="<?= $objTransactionMaster->note ?>" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-4 control-label" for="txtReferencia1">Referencia 1</label>
                                <div class="col-lg-8">
                                    <input class="form-control" type="text" name="txtReferencia1" id="txtReferencia1" value="<?= $objTransactionMaster->reference2 ?>" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-4 control-label" for="txtReferencia2">Referencia 2</label>
                                <div class="col-lg-8">
                                    <input class="form-control" type="text" name="txtReferencia2" id="txtReferencia2" value="<?= $objTransactionMaster->reference3 ?>" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-4 control-label" for="txtReferencia3">Referencia 3</label>
                                <div class="col-lg-8">
                                    <input class="form-control" type="text" name="txtReferencia3" id="txtReferencia3" value="<?= $objTransactionMaster->reference4 ?>" />
                                </div>
                            </div>
                        </div>
                    </div>
