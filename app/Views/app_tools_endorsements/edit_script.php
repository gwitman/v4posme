        ...
        function fnMostrarCampoByTypeEndorsements(endoso) {
            if (endoso) {
                ...
                if (tipo === "datetime") {
                    ...
                    tagContenedorValorNuevo.html('<input type="datetime-local" name="txtValorNuevo" id="txtValorNuevo" class="form-control" value="'+ valorNuevoEndosar +'">');
                    ...
                    tagContenedorValorNuevo.html('<input type="text" name="txtValorNuevo" id="txtValorNuevo" class="form-control" value="'+ valorNuevoEndosar +'">');
                }
            }
        }
