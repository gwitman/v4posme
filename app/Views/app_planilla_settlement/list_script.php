<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '#btnNuevo', function() {
            fnWaitOpen();
            window.location = '<?php echo base_url(); ?>/app_planilla_settlement/add';
        });
        ...
        $(document).on("click","#btnEdit",function(){
            ...
            if(objRowTableListView != undefined){
                ...
                window.location	= "<?php echo base_url(); ?>/app_planilla_settlement/edit/companyID/"+data[0]+"/transactionID/"+data[1]+"/transactionMasterID/"+data[2];
            }
            else{
            ...
            if(objRowTableListView != undefined){
                ...
                fnShowConfirm("Confirmar..","Desea eliminar este Registro...",function(){
                    ...
                    $.ajax({									
                        ...
                        dataType    : 'json',
                        type        : 'POST',
                        url  		: "<?php echo base_url(); ?>/app_planilla_settlement/delete",
        ...
        $(document).on("click","#btnSearchTransaction",function(){
            ...
            $.ajax({									
                ...
                dataType    : 'json',
                type        : 'POST',
                url  		: "<?php echo base_url(); ?>/app_planilla_settlement/searchTransactionMaster",
                ...
                success:function(data){
                    ...
                    if(data.error){
                        ...
                        window.location = "<?php echo base_url(); ?>/app_planilla_settlement/edit/companyID/"+data.companyID+"/transactionID/"+data.transactionID+"/transactionMasterID/"+data.transactionMasterID;
                    }
                },
                error:function(xhr,data){	
                    console.info("complete delete error");									
        ...
        function fn_aceptCallback(data){
			...
			window.location = "../../app_planilla_settlement/index/"+dataViewID;   
	    }	
