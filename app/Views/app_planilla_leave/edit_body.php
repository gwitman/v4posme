                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="hidden" id="txtEndvsIntegrationDiff" name="txtEndvsIntegrationDiff" value="<?php echo $objTM->amount ?>">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" readonly type="text" name="txtEmployeeVacationDays" id="txtEmployeeVacationDays" value="<?php echo number_format($objTM->amount, 2) ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <textarea class="form-control" type="text" name="txtEmployeeLeaveNote" id="txtEmployeeLeaveNote"><?php echo $objTM->note; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                            ...
                                            <select name="txtEmployeeTypeLeave" id="txtEmployeeTypeLeave" class="select2">
                                                ...
                                                if ($objListLeaveStatus)
                                                    foreach ($objListLeaveStatus as $ws) {
                                                        if ($ws->catalogItemID == $objTM->areaID)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <div id="datepicker" class="input-group date" data-date="" data-date-format="yyyy-mm-dd">
                                                <input size="16" class="form-control" type="text" name="txtEmployeeLeaveStartDate" id="txtEmployeeLeaveStartDate" value="<?php echo explode(' ', $objTM->transactionOn)[0]; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <div id="datepicker" class="input-group date" data-date="" data-date-format="yyyy-mm-dd">
                                                <input size="16" class="form-control" type="text" name="txtEmployeeLeaveEndDate" id="txtEmployeeLeaveEndDate" value="<?php echo explode(' ', $objTM->transactionOn2)[0]; ?>">
                                                <span class="input-group-addon"><i class="icon16 i-calendar-4"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <div id="datepicker" class="input-group date" data-date="" data-date-format="yyyy-mm-dd">
                                                <input size="16" class="form-control" type="text" name="txtEmployeeLeaveIntegrationDate" id="txtEmployeeLeaveIntegrationDate" value="<?php echo explode(' ', $objTM->nextVisit)[0]; ?>">
                                                <span class="input-group-addon"><i class="icon16 i-calendar-4"></i></span>
                                            </div>
                                        </div>
                                    </div>
