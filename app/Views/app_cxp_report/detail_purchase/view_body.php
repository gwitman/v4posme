                                        ...
                                        <form class="form-horizontal pad15 pad-bottom0" role="form">											
											...
											<div class="form-group">
												...
												<div class="col-lg-6"> 
													...
													<div class="col-lg-6">
														<select name="txtProviderID" id="txtProviderID" class="select2">
																<option value="0">TODOS</option>
																<?php
																if($objListProvider)
											...
											<div class="form-group">
												<label class="col-lg-6 control-label" for="selectFilter">Producto</label>
												<div class="col-lg-6"> 
													<div class="col-lg-12">
														<div class="input-group">
																<input type="hidden" id="txtItemID" name="txtItemID" value="0">
																<input class="form-control" readonly id="txtItemName" type="txtItemName" value="TODOS">
																<span class="input-group-btn">
																	<button class="btn btn-danger" type="button" id="btnClearItem">
																		<i aria-hidden="true" class="i-undo-2"></i>
																		clear
																	</button>
																</span>
																<span class="input-group-btn">
																	<button class="btn btn-primary" type="button" id="btnSearchItem">
