				...
				<script>	
					...
					$(document).ready(function(){					
						...
						$(document).on("click","#btnAcept",function(){
								...
								$( "#form-new-account-journal" ).attr("action","<?php echo base_url(); ?>/app_inventory_datasheet/save/new"); 
						...
						$(document).on("click","#txtSearchItemID",function(){
							var url_request = "<?php echo base_url(); ?>/core_view/showviewbyname/<?php echo $componentItemID; ?>/onCompleteItemReceta/SELECCIONAR_ITEM_TO_RECETA/true/empty";
						...
						$(document).on("click","#btnNewDetail",function(){
							...
							var url_request 		= "<?php echo base_url(); ?>/core_view/showviewbyname/<?php echo $componentItemID; ?>/onCompleteItem/SELECCIONAR_ITEM_TO_RECETA/true/empty";
							window.open(url_request,"MsgWindow","width=900,height=450");
