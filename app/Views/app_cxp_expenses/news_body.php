										...
										<div class="tab-pane fade in active" id="home">	
											<div class="row">										
												<div class="col-lg-6">
														...
														<div class="form-group">
																<label class="col-lg-4 control-label" for="normal"><?php echo getBehavio($company->type,"comand_traducir","Referencia 1"); ?></label>
																<div class="col-lg-8">																	
														...
														<div class="form-group">
																<label class="col-lg-4 control-label" for="normal"><?php echo getBehavio($company->type,"comand_traducir","Referencia 2"); ?></label>
																<div class="col-lg-8">
														...
														<div class="form-group">
																<label class="col-lg-4 control-label" for="normal"><?php echo getBehavio($company->type,"comand_traducir","Referencia 3"); ?></label>
																<div class="col-lg-8">																	
