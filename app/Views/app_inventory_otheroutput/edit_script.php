...
<script>	
	...
	$(document).ready(function(){					
		...
		$(document).on("click","#btnPrinter",function(){
			fnWaitOpen();							
			window.location = "<?php echo base_url(); ?>/app_inventory_otheroutput/viewRegister/companyID/<?php echo $objTM->companyID;?>/transactionID/<?php echo $objTM->transactionID;?>/transactionMasterID/<?php echo $objTM->transactionMasterID;?>";
		});
		...
		$(document).on("click","#btnNewDetailTransaction",function(){							
			...
			var url_request 		= "<?php echo base_url(); ?>/core_view/showviewbyname/<?php echo $componentItemID; ?>/onCompleteItem/SELECCIONAR_ITEM_TO_OUTPUT/true/"+encodeURI("{\"warehouseID\"|\""+$("#txtWarehouseSourceID").val()+"\"}");
