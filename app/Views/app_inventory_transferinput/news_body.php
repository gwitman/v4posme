                        ...
                        <div id="email" class="col-lg-12">
                            <div class="email-bar" style="border-left:1px solid #c9c9c9">
                                <div class="btn-group pull-right">
									<a href="<?php echo base_url(); ?>/app_inventory_transferinput/index" id="btnBack" class="btn btn-inverse" ><i class="icon16 i-rotate"></i> Atras</a>
									...
									<div class="tab-content">
										...
										<div class="tab-pane fade in active" id="home">	
											...
											<div class="col-lg-6">
													...
													<div class="form-group">
														<label class="col-lg-2 control-label" for="selectFilter">B. Destino</label>
														<div class="col-lg-8">
