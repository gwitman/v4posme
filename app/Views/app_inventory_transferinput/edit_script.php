				...
				<script>	
					...
					$(document).ready(function(){					
						...
						$(document).on("click","#btnPrinter",function(){
							fnWaitOpen();							
							window.location = "<?php echo base_url(); ?>/app_inventory_transferinput/viewRegister/companyID/<?php echo $objTM->companyID;?>/transactionID/<?php echo $objTM->transactionID;?>/transactionMasterID/<?php echo $objTM->transactionMasterID;?>";
						});
						...
						$(document).on("click","#btnDelete",function(){
							fnShowConfirm("Confirmar..","Desea eliminar este Registro...",function(){
								...
								$.ajax({									
									...
									dataType    : 'json',
									type        : 'POST',
									url  		: "<?php echo base_url(); ?>/app_inventory_transferinput/delete",
									...
									success:function(data){
										...
										if(data.error){
											...
											window.location = "<?php echo base_url(); ?>/app_inventory_transferinput/index";
										}
									},
						...
						$(document).on("click","#btnAcept",function(){
								...
								$( "#form-new-transaction" ).attr("action","<?php echo base_url(); ?>/app_inventory_transferinput/save/edit");
						...
						$(document).on("click","#btnNewDetailTransaction",function(){							
							...
							var url_request	= "<?php echo base_url(); ?>/core_view/showviewbyname/<?php echo $componentItemID; ?>/onCompleteItem/SELECCIONAR_ITEM_TO_TRANSFERINPUT/true/"+encodeURI("{\"warehouseSourceID\"|\""+$("#txtWarehouseSourceID").val()+"\"{}\"userID\"|\"<?php echo $userID; ?>\"}") + "/false/not_redirect_when_empty";
