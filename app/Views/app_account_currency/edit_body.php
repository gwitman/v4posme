                        ...
                        <div id="email" class="col-lg-12">
                            ...
                            <div class="email-bar" style="border-left:1px solid #c9c9c9">                                
                                <div class="btn-group pull-right">                                    
									<a href="<?php echo base_url(); ?>/app_accounting_currency/index" id="btnBack" class="btn btn-inverse" ><i class="icon16 i-rotate"></i> Atras</a>
											...
											<div class="email-content col-lg-12">
												...
												<form id="form-new-account-level" name="form-new-rol" class="form-horizontal" role="form">
													<fieldset>		
														...
														<input type="hidden" name="txtCompanyID" value="<?php echo $objCompanyCurrency->companyID; ?>" />
														<input type="hidden" name="txtCurrencyID" value="<?php echo $objCompanyCurrency->currencyID; ?>" />
															...
															<div class="col-lg-5">
																<select name="txtCurrencyID" id="txtCurrencyID" class="select2">
																		...
																		foreach($objListCurrency as $i){
																			if($i->currencyID == $objCompanyCurrency->currencyID)
														...
														<div class="form-group">
																...
																<div class="col-lg-10">
																	<input class="form-control"  type="text" name="txtSimb" id="txtSimb" value="<?php echo $objCompanyCurrency->simb; ?>">												
																</div>
														</div>
