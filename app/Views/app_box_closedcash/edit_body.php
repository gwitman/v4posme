	...
	<div id="email" class="col-lg-12">
		...
		<div class="email-bar" style="border-left:1px solid #c9c9c9">
			<div class="btn-group pull-right">
				<a href="<?php echo base_url(); ?>/app_box_closedcash/add" class="btn btn-success" id="btnNuevo"><i class="icon16 i-checkmark-4"></i>Nuevo</a>
				<a href="<?php echo base_url(); ?>/app_box_closedcash/index" id="btnBack" class="btn btn-inverse" ><i class="icon16 i-rotate"></i> Atras</a>
						...
						<div class="row">
							<div class="col-lg-6">
									...
									<div class="form-group">
											...
											<div class="col-lg-5">
												<input type="checkbox" disabled   name="txtIsApplied" id="txtIsApplied" value="1"												                                                                                 												                                                                                 												                                                                                  <?php if ($objTransactionMaster->isApplied) {
                                                                                                                                                                                                                                                                                                                                                                                                            echo "checked";
                                                                                                                                                                                                                                                                                                                                                                                                    }
                                                                                                                                                                                                                                                                                                                                                                                                    ?> >
											</div>
											...
											<?php
                                                if (isset($objListCashBox)) {
                                                    ...
                                                    foreach ($objListCashBox as $cb) {
                                                        if ($cb->cashBoxID == $objTransactionMaster->classID) {
