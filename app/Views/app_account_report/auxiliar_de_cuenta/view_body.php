								...
								<div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form class="form-horizontal pad15 pad-bottom0" role="form">
											...
											<div class="form-group">
												<label class="col-lg-6 control-label" for="selectFilter">Ciclo Inicial y Final</label>
												<div class="col-lg-6"> 
													<div class="col-lg-6">
														<select name="txtMayorizateCicleStart" id="txtMayorizateCicleStart" class="select2">
																<option></option>																
														</select>
													</div>
													<div class="col-lg-6">
														<select name="txtMayorizateCicleEnd" id="txtMayorizateCicleEnd" class="select2">
															<option></option>															
														</select>
													</div>													
												</div>
											...
											<div class="form-group">
												<label class="col-lg-6 control-label" for="selectFilter">Cuenta</label>
												<div class="col-lg-6"> 
													<div class="col-lg-12">
														<select name="txtAccount" id="txtAccount" class="select2">
															<option></option>															
															<?php
																if($objListAccount)
																foreach($objListAccount as $i){
																	echo "<option value='".$i->accountID."'>".$i->accountNumber." --- ".$i->name."</option>";
																}
															?>
														</select>
													</div>													
