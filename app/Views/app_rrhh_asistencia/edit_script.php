				...
				<script>		
					...
					$(document).ready(function(){					
						...
						$(document).on("click","#btnAcept",function(){
								...
								$( "#form-new-invoice" ).attr("action","<?php echo base_url(); ?>/app_rrhh_asistencia/save/edit");
						...
						$(document).on("click","#btnPrinter",function(){
									fnWaitOpen();
									window.open("<?php echo base_url(); ?>"+"/app_rrhh_asistencia/viewRegisterFormatoPaginaTicket80mm"+"/companyID/<?php echo $objTransactionMaster->companyID;?>/transactionID/<?php echo $objTransactionMaster->transactionID;?>/transactionMasterID/<?php echo $objTransactionMaster->transactionMasterID;?>", '_blank');
									fnWaitClose();																	
						});
								...
								$.ajax({									
									...
									success:function(data){
										...
										if(data.error){
											...
											window.location = "<?php echo base_url(); ?>/app_rrhh_asistencia/index";
										}
									},
