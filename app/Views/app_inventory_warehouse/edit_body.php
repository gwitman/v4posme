                        ...
                        <div id="email" class="col-lg-12">
                            ...
                            <div class="email-bar" style="border-left:1px solid #c9c9c9">                                
                                <div class="btn-group pull-right">                                    
									<a href="<?php echo base_url(); ?>/app_inventory_warehouse/index" id="btnBack" class="btn btn-inverse" ><i class="icon16 i-rotate"></i> Atras</a>
												...
												<form id="form-new-account-type" name="form-new-rol" class="form-horizontal" role="form">
													<fieldset>		
														...
														<div class="form-group">
															...
															<div class="col-lg-4">
																<select name="txtBranchIDDescription" id="txtBranchIDDescription"  class="select2">
																		<option></option>
																		<?php
																		if($objListBranch)
														...
														<div class="form-group">
																...
																<div class="col-lg-4">
																	<input class="form-control"  type="text" name="txtEmailResponsability" id="txtEmailResponsability" value="<?php echo $objWarehouse->emailResponsability; ?>">
																</div>
														</div>
