                                    ...
                                    <div class="panel-body">
                                        <form class="form-horizontal pad15 pad-bottom0" role="form">											
												<div class="form-group">
													<label class="col-lg-6 control-label" for="selectFilter">Colaboradores</label>
													<div class="col-lg-6"> 
														<div class="col-lg-6">
														</div>
														<div class="col-lg-6">
															<select name="employerID" id="employerID" class="select2" multiple >
																	<option value="0">TODOS</option>
																	<?php
																	if($objListaEmployer)
																	foreach($objListaEmployer as $i){
