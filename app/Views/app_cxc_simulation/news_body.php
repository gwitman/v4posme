													...
													<div class="form-group">
														...
														<div class="col-lg-8">
															<div class="input-group">
																...
																<input class="form-control" readonly id="txtCustomerDescription" type="txtCustomerDescription" value="<?php echo $objNaturalDefault != null ? strtoupper($entityNumber . " ". $objNaturalDefault->firstName . " ". $objNaturalDefault->lastName ) : strtoupper($entityNumber." ".$objLegalDefault->comercialName); ?>">
