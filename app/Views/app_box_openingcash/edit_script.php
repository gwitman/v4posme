				...
				<script>		
					...
					$(document).ready(function(){					
						...
						$(document).on("click","#btnAcept",function(){
								...
								$( "#form-new-invoice" ).attr("action","<?php echo base_url(); ?>/app_box_openingcash/save/edit");
								...
								$.ajax({									
									...
									success:function(data){
										...
										if(data.error){
											...
											window.location = "<?php echo base_url(); ?>/app_box_openingcash/index";
										}
									},
						...
						$(document).on("change","#txtAreaID",function(){
							...
							$.ajax({									
								...
								data		: {catalogItemID : TipoMovimiento, tableName : "tb_transaction_master_opening_cash" , fieldName: "priorityID" },
