    ...
    <div id="email" class="col-lg-12">
        ...
        <div class="email-bar" style="border-left:1px solid #c9c9c9">
            <div class="btn-group pull-right">
                <a href="<?php echo base_url(); ?>/app_bank_cheque/add" class="btn btn-success" id="btnNuevo"><i class="icon16 i-checkmark-4"></i>Nuevo</a>
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                ...
                <h4>Cheque:#<span class="invoice-num"><?= $objBC->chequeNumber ?></span></h4>
            </div>
            <!-- /titulo de comprobante-->
            ...
            <form id="form-new-bankCheque" name="form-new-bankCheque" class="form-horizontal" role="form">
                <div class="panel-body printArea">
                    ...
                    <div class="tab-content">
                        <input type="hidden" name="txtChequeID" id="txtChequeID" value="<?= $objBC->chequeID ?>">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" type="text" name="txtName" id="txtName" value="<?= $objBC->name ?>">
                                        </div>
                                    </div>
                                            ...
                                            <select name="txtStatusID" id="txtStatusID" class="select2">
                                                ...
                                                if ($objListWorkflowStage)
                                                    foreach ($objListWorkflowStage as $ws) {
                                                        if($ws->workflowStageID == $objBC->statusID)
                                                        {
                                            ...
                                            <select name="txtCurrencyID" id="txtCurrencyID" class="select2">
                                                ...
                                                if ($objListCurrency)
                                                    foreach ($objListCurrency as $ws) {
                                                        if ($ws->currencyID == $objBC->currencyID)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                <input type="hidden" id="txtBankID" name="txtBankID" value="<?= $objBC->bankID ?>">
                                                <input class="form-control" readonly id="txtBankDescription" type="txtBankDescription" value="<?= $objBank->name ?>">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" type="text" name="txtInitialValue" id="txtInitialValue" value="<?= $objBC->valueInitial ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" type="text" name="txtFinalValue" id="txtFinalValue" value="<?= $objBC->valueFinal ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" readonly type="text" name="txtCurrentValue" id="txtCurrentValue" value="<?= $objBC->valueCurrent ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" type="text" name="txtSerie" id="txtSerie" value="<?= $objBC->serie ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                <input type="hidden" id="txtEmployeeEntityID" name="txtEmployeeEntityID" value="<?= $objBC->managerID ?>">
