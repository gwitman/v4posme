				...
				<script>
				    $(document).ready(function() {
				        ...
				        $(document).on("click", "#btnAcept", function() {
				            ...
				            $("#form-new-bankCheque").attr("action", "<?php echo base_url(); ?>/app_bank_cheque/save/edit");
						...
						$(document).on("click", "#btnDelete", function() {
							fnShowConfirm("Confirmar..", "Desea eliminar este Registro...", function() {
								...
								$.ajax({
									...
									data: {
										chequeID: <?php echo $objBC->chequeID; ?>
									},
									success: function(data) {
										...
										if (data.error) {
											...
											window.location = "<?php echo base_url(); ?>/app_bank_cheque/index";
										}
									},
