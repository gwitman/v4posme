				...
				<script>		
					...
					$(document).ready(function(){					
						...
						$(document).on("click","#btnNewShare",function(){
							...
							var url_request 			= "<?php echo base_url(); ?>/core_view/showviewbyname/<?php echo $objComponentCustomerCreditDocument->componentID; ?>/onCompleteNewShare/SELECCIONAR_DOCUMENTOS_DE_CREDITO_SUMMARY/true/"+encodeURI("{\"entityID\"|\""+$("#txtCustomerID").val()+"\"}");
