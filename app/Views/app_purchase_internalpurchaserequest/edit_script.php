				...
				<script>	
					...
					$(document).ready(function(){					
						...
						$(document).on("click","#btnPrinter",function(){
							fnWaitOpen();							
							window.location = "<?php echo base_url(); ?>/app_purchase_internalpurchaserequest/viewRegister/companyID/<?php echo $objTM->companyID;?>/transactionID/<?php echo $objTM->transactionID;?>/transactionMasterID/<?php echo $objTM->transactionMasterID;?>";
						});
						//Archivos
								...
								$.ajax({									
									...
									success:function(data){
										...
										if(data.error){
											...
											window.location = "<?php echo base_url(); ?>/app_purchase_internalpurchaserequest/index";
										}
									},
						...
						$(document).on("click","#btnAcept",function(){
								...
								$( "#form-new-transaction" ).attr("action","<?php echo base_url(); ?>/app_purchase_internalpurchaserequest/save/edit");
						...
						$(document).on("click","#btnImportDetailTransaction",function(){
							...
							$.ajax({									
								...
								dataType    : 'json',
								type        : 'POST',
								url  		: "<?php echo base_url(); ?>/app_purchase_internalpurchaserequest/getInfoImport",
						...
						$(document).on("click","#btnNewDetailTransaction",function(){							
							...
							//var url_request 		= "<?php echo base_url(); ?>/core_view/showviewbyname/<?php echo $componentItemID; ?>/onCompleteItem/SELECCIONAR_ITEM_TO_SOLICGENERAL/true/"+encodeURI('{\"warehouseTargetID\"|\"'+$("#txtWarehouseTargetID").val()+'\"{}\"warehouseSourceID\"|\"'+$("#txtWarehouseSourceID").val()+'\"}');  
							var url_request 		= "<?php echo base_url(); ?>/core_view/showviewbyname/<?php echo $componentItemID; ?>/onCompleteItem/SELECCIONAR_ITEM_TO_SOLICGENERAL/true/"+encodeURI('{\"warehouseSourceID\"|\"'+$("#txtWarehouseSourceID").val()+'\"}');  
