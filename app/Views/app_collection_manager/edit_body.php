										...
										<div class="row">
											<div class="email-content col-lg-12">
												...
												<form id="form-new-account-type" name="form-new-rol" class="form-horizontal" role="form">
                                                    <input type="hidden" id="txtRelationshipID" name="txtRelationshipID" value="<?php echo $objRelationship->relationshipID; ?>">
													<fieldset>															
														<div class="form-group">
															...
															<div class="col-lg-8">
																<div class="input-group">
																	<input type="hidden" id="txtEmployeeID" name="txtEmployeeID" value="<?php echo $objRelationship->employeeID; ?>">
																	<input class="form-control" readonly id="txtEmployeeDescription" type="text" value="<?php echo $objRelationship->firstName; ?>">																
														...
														<div class="form-group">
															...
															<div class="col-lg-8">
																<div class="input-group">
																	<input type="hidden" id="txtCustomerID" name="txtCustomerID" value="<?php echo $objRelationship->customerID; ?>">
																	<input class="form-control" readonly id="txtCustomerDescription" type="text" value="<?php echo $objRelationship->legalName; ?>">																
														...
														<div class="form-group">
															...
															<div class="col-lg-8">
																<div class="input-group">	
																	<input class="form-control" type="text" name="txtReference4" id="txtReference4" value="<?php echo $objRelationship->reference4; ?>"  >																																																																																																		
																</div>
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-lg-8">
																<div class="input-group">	
																	<input class="form-control" type="text" name="txtReference5" id="txtReference5" value="<?php echo $objRelationship->reference5; ?>"  >																																																																																																		
																</div>
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-lg-8">
																<div class="input-group">	
																	<input class="form-control" type="text" name="txtDescripcion" id="txtDescripcion" value="<?php echo $objRelationship->descripcion; ?>"  >																																																																																																		
																</div>
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-lg-8">
																<div class="input-group">
																	<input type="hidden" id="txtCustomerIDAfter" name="txtCustomerIDAfter" value="<?php echo $objCustomerAfter ? $objCustomerAfter->entityID : 0; ?>">
																	<input class="form-control" readonly id="txtCustomerDescriptionAfter" name="txtCustomerDescriptionAfter" type="text" value="<?php echo $objCustomerAfter ? $objCustomerAfter->customerNumber." / ".$objCustomerAfter->firstName." ".$objCustomerAfter->lastName : ""; ?>">
