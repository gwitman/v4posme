				<div id="heading" class="page-header">
					<h1><i class="icon20   i-drawer-2"></i> LISTA DE COMPROBANTES</h1>
				</div>
									...
									<form class="navbar-form navbar-left" role="search">
										<div class="col-lg-12 srch">
											<div class="input-group-btn">
												<input type="text" class="form-control" id="txtSearchJournal" placeholder="search ...">
												<button type="button" class="btn" id="btnSearchJournal" ><i class="icon16 i-search-2 gap-left5"></i></button>
											</div>
										</div>
									</form>
