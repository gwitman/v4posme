                        ...
                        <div id="email" class="col-lg-12">
                            ...
                            <div class="email-bar" style="border-left:1px solid #c9c9c9">                                
                                <div class="btn-group pull-right">                                    
									<a href="<?php echo base_url(); ?>/app_accounting_journal/edit/companyID/<?php echo ($objBackJournal != NULL ? $objJournalEntry->companyID : 0); ?>/journalEntryID/<?php echo ($objBackJournal != NULL ?  $objBackJournal->journalEntryID : 0); ?>" class="btn btn-primary" ><i class="icon16 i-backward-2"></i> Anterior</a>                                    
									<a href="<?php echo base_url(); ?>/app_accounting_journal/edit/companyID/<?php echo ($objNextJournal != NULL ? $objJournalEntry->companyID : 0); ?>/journalEntryID/<?php echo ($objNextJournal != NULL ?  $objNextJournal->journalEntryID : 0); ?>" class="btn btn-primary" ><i class="icon16 i-forward-3"></i> Siguiente</a>                                    									
									<a href="<?php echo base_url(); ?>/app_accounting_journal/add"  class="btn btn-warning" ><i class="icon16 i-pushpin"></i> Nuevo</a>                                    
