				...
				<script>					
					...
					$(document).ready(function(){					
						...
						$(document).on("click","#btnOpenTemplated",function(){
							var url_request 				= "<?php echo base_url(); ?>/core_view/showviewbyname/<?php echo $componentAccountID; ?>/onCompleteSelectTemplate/SELECCIONAR_TEMPLATED/true/empty";
						...
						$(document).on("click","#btnNewDetailJournal",function(){
							var url_request 				= "<?php echo base_url(); ?>/core_view/showviewbyname/<?php echo $componentAccountID; ?>/onCompleteNewAccount/SELECCIONAR_CUENTA/true/empty";
							window.open(url_request,"MsgWindow","width=900,height=450");
