				<div id="heading" class="page-header">
					<h1><i class="icon20   i-certificate"></i> CONFIG. NOTIFICACIONES </h1>
				</div>
				<div class="row">  
					...
					<div class="email-bar" style="width:100%">
							<form class="navbar-form navbar-left" role="search">
								<div class="col-lg-12 srch">
									<div class="input-group-btn">
										...
										<button type="submit" class="btn"><i class="icon16 i-search-2 gap-left5"></i></button>
									</div>
								</div>
							</form>
							<div class="btn-group pull-right" >
								...
								<a href="#" class="btn btn-warning" id="btnSendWhatapp"><i class="icon16 i-airplane"></i> Enviar Whatsapp</a>
