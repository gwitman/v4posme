				...
				<script>
					$(document).ready(function(){						 
						...
						$(document).on("click","#btnAcept",function(){
								...
								$( "#form-new-invoice" ).attr("action","<?php echo base_url(); ?>/app_planilla_adelantos/save/edit");
						...
						$(document).on("click","#btnNewShare",function(){
							var url_request 			= "<?php echo base_url(); ?>/core_view/showviewbyname/<?php echo $objComponentEmployee->componentID; ?>/onCompleteNewShare/SELECCIONAR_EMPLOYEE/true/empty";
