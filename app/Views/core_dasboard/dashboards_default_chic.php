				...
				<div class="row">
					 <div class="col-lg-6">		
						...
						<div class="panel show-sales" style="margin-bottom:20px;">
							<div class="panel-heading">
								<div class="icon"><i class="icon20 i-health"></i></div> 
				...
				<script>	
					...
					function showSalesFunction()
					{
						if(!showSales)
						{
							let elements = document.querySelectorAll(".show-sales");
							elements.forEach(el => {
								el.style.display = "none"; // o "flex" según lo que necesites
							});
						}
					}
					showSalesFunction();
