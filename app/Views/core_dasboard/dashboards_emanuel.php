						...
						<div class="panel" style="margin-bottom:20px;">
							...
							<div class="panel-body">	
								...
								echo '<table>';
									...
									foreach ($objSales as $venta) {
										$transactionNumber = $venta['transactionNumber'];
										$tipo = $venta['tipo'];
										$zone = $venta['zone'];
										$moneda = $venta['currencyName'];
										$total = number_format((float)$venta['totalDocument'], 2);
										...
										$totalGeneral += (float)$venta['totalDocument'];
									}
									...
									echo "<tfoot>
											<tr>
												...
												<td class='total' >C$ {$totalGeneralFormateado}</td>
											</tr>
										  </tfoot>";
									echo '</table>';
