			...
			<thead>
				<tr>
					...
					<th colspan="8" style="
						...
						width:80%
					">LISTA DE ITEM CON EXISTENCIA UNICAMENTE</th>
				</tr>
				<tr>
					<th colspan="8" style="
						text-align:right;background-color:#00628e;color:white;
		...
		" >
			<thead >
				...
				<tr style="background-color:#00628e;color:white;">
					...
					<th  style="text-align:left;text-align:left;width:100px;"    colspan="1" class="border">Categoria</th>	
					
					<th  style="text-align:right;width:80px;"  colspan="4"   class="border">Cantidad</th>
			...
			<tfoot>
				...
				<tr style="background-color:#00628e;color:white;">
					<!--812-->					
					<th  style="text-align:left;" style="text-align:left;width:80px;"   colspan="1" class="border">Codigo</th>
					<th  style="text-align:left;"  colspan="6" class="border">Nombre</th>						
					<th  style="text-align:left;" style="text-align:left;width:100px;"   colspan="1" class="border">Categoria</th>	
					<th  style="text-align:right;width:80px;" colspan="4"   class="border">Cantidad</th>
					<th  style="text-align:left;width:80px;" class="border">Costo</th>
