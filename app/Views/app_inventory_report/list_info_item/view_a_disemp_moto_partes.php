		...
		">
			<thead>
				<tr>
					...
					<th colspan="8" style="
						text-align:center;background-color:#00628e;color:white;
						width:80%
					">LISTA DE ITEM</th>
				</tr>
				<tr>
		...
		<table style="width:100%;" id="myReport" >
			<thead >
				...
				<tr style="background-color:#00628e;color:white;">
					<!--812-->					
					<th  style="" class="border">Codigo de Barra</th>
					<th  style="" class="border">Nombre</th>						
					<th  style="" class="border">Precio</th>	
					<th  style="" class="border">Existencia</th>	
				...
				if($objDetail){
					...
					foreach($objDetail as $i){						
						echo "<tr  >";
							...
							echo "</td>";	
							echo "<td style='text-align:right'   class='border' >";
								echo (number_format( $i["quantity"],0,'.',','));
							echo "</td>";	
							echo "<td style='text-align:left'   class='border' >";
								echo ($i["categoryName"]);
							echo "</td>";								
