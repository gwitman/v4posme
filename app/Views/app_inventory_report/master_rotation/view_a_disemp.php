		...
		">
			<thead>
				...
				<tr>
					<th colspan="9" style="
						text-align:right;background-color:#00628e;color:white;
					">REPORTE DE <?php echo $startOn; ?> AL <?php echo $endOn; ?> <?php echo ($objWarehouse != null ? "EN ".$objWarehouse->name : ""); ?></th>
				</tr>
				<tr>
		...
		<table style="width:100%;" id="myReport"  >
			<thead>
				<tr style='background-color:#00628e;color:white'>
					<td style="text-align:left;font-weight:bold" class="border">Codigo del prodcuto</td>
					<td style="text-align:left;font-weight:bold" class="border">Nombre del producto</td>
			...
			<tbody>
				...
				foreach($objDetail as $i)
				{
					...
					echo "<tr>";
						...
						echo "<td style='text-align:right;border-top: 0px'  class='border'>";
							echo (number_format($i["cantidad_venta"],2,'.',','));
						echo "</td>";
						
						echo "<td style='text-align:right;border-top: 0px' class='border'>";
							echo (number_format($i["quantity_actual"],2,'.',','));
						echo "</td>";
