			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal pad15 pad-bottom0" role="form">											
						...
						<div class="form-group <?php echo $hiddenDateStartAndEnd; ?>">
						...
						<div class="form-group <?php echo $hiddenHourStartAndEnd; ?>">
							<label class="col-lg-6 control-label" for="selectFilter">Hora Inicial y Final</label>
							<div class="col-lg-6"> 
								<div class="col-lg-6">
									<?php 
									echo helper_GetHtmlControlHora("txtHoraInicial",helper_getDate());
									?>
								</div>
								<div class="col-lg-6">
									<?php 
									echo helper_GetHtmlControlHora("txtHoraFinal",helper_getDateTime());
									?>
								</div>													
							</div>
						</div>
