    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                ...
                <h4>Retencion:#<span class="invoice-num">00000000</span></h4>
            </div>
            <!-- /titulo de comprobante-->
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                <input type="hidden" id="txtProviderEntityID" name="txtProviderEntityID" value="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" type="text" name="txtInvoice" id="txtInvoice" value="">
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" type="text" name="txtInvoiceAmount" id="txtInvoiceAmount" value="0">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" readonly type="text" name="txtWithholdingAmount" id="txtWithholdingAmount" value="0">
                                        </div>
                                    </div>
