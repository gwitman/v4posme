...
<html lang="en">
	...
	<body style="font-family:monospace;font-size:smaller;margin:0px 0px 0px 0px"> 
		...
		$configColumn["5"]["Width"] 		= "250px";
		$configColumn["6"]["Width"] 		= "250px";
		$configColumn["7"]["Width"] 		= "250px";
		$configColumn["8"]["Width"] 		= "250px";
		$configColumn["9"]["Width"] 		= "250px";
		$configColumn["10"]["Width"] 		= "250px";
