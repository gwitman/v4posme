				...
				<script>				
					$(document).ready(function(){
						...
						$(document).on("click","#print-btn-report",function(){
							...
							if(!( startOn == "" || endOn == "" ) ){
								fnWaitOpen();
								window.location	= "<?php echo base_url(); ?>/app_sales_report/sales_detail_traking_globalpro/viewReport/true/startOn/"+startOn+"/endOn/"+endOn+"/inventoryCategoryID/"+inventoryCategoryID+"/warehouseID/"+warehouseID;
							}
							else{
