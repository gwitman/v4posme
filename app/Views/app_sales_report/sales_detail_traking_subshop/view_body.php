						...
						<div class="col-lg-12">
								<div class="panel panel-default">
                                    <div class="panel-heading">
                                        ...
                                        <h4>SEGUIMIENTO DE SUB TIENDA</h4>
                                    ...
                                    <div class="panel-body">
                                        <form class="form-horizontal pad15 pad-bottom0" role="form">											
											...
											<div class="form-group">
												<label class="col-lg-6 control-label" for="selectFilter">Clave</label>
												<div class="col-lg-6"> 
													<div class="col-lg-6">
													</div>
													<div class="col-lg-6">
														<input class="form-control" type="text" name="keyWarehouse" id="keyWarehouse" />
													</div>													
												</div>
											</div>
