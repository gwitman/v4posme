...
<script>	
	...
	$(document).ready(function(){					
		...
		$(document).on("click","#btnAcept",function(){
				...
				$( "#form-new-transaction" ).attr("action","<?php echo base_url(); ?>/app_inventory_otherinput/save/new");
		...
		$(document).on("click","#btnNewDetailTransaction",function(){
			...
			var url 		= "<?php echo base_url(); ?>/core_view/showviewbyname/<?php echo $componentItemID; ?>/onCompleteItem/SELECCIONAR_ITEM/true/"+encodeURI("{\"familyID\"|\"75\"}");
			var url_request = "<?php echo base_url(); ?>/core_view/showviewbyname/<?php echo $componentItemID; ?>/onCompleteItem/SELECCIONAR_ITEM_TO_INPUT/true/"+encodeURI("{\"warehouseID\"|\""+$("#txtWarehouseSourceID").val()+"\"}");
	...
	function onCompleteItem(objResponse){
		...
		objRow.itemNumber,objRow.itemName,objRow.itemUM,objRow.quantity,
		objRow.cost,objRow.total,objRow.lote,objRow.vencimiento,
		objRow.masinfor]);
		refreschChecked();
