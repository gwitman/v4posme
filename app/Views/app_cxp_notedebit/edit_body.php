    ...
    <div id="email" class="col-lg-12">
        ...
        <div class="email-bar" style="border-left:1px solid #c9c9c9">
            <div class="btn-group pull-right">
                <a href="<?php echo base_url(); ?>/app_cxp_notedebit/add" class="btn btn-success" id="btnNuevo"><i class="icon16 i-checkmark-4"></i>Nuevo</a>
                <a href="<?php echo base_url(); ?>/app_cxp_notedebit/index" id="btnBack" class="btn btn-inverse"><i class="icon16 i-rotate"></i> Atras</a>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                <input type="hidden" id="txtProviderEntityID" name="txtProviderEntityID" value="<?php echo $objTM->entityID ?>">
                                                <input class="form-control" readonly id="txtProviderDescription" type="txtProviderDescription" value="<?php echo $objProvider->providerNumber . " | " . $objListNatural->firstName . " " . $objListNatural->lastName ?>">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <textarea class="form-control" id="txtComment" name="txtComment" rows="6"><?php echo $objTM->note; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
