			...
			<div class="btn-group pull-right">
                    ...
                    ?>
						...
						<ul class="dropdown-menu">
							<li><a href="#" id="btnPrinterSinPrecio"    ><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><i class="icon16 i-print"></i> Sticker sin precio</font></font></a></li>
			...
			<div class="panel-body printArea">
				...
				<div class="tab-content">
					<div class="tab-pane fade in active" id="home">
						...
						<div class="col-lg-6">
                                ...
                                <div class="form-group                                                       <?php echo getBehavio($company->type, "app_inventory_item", "divTxtBirthday", "hidden"); ?>" >
                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group date" data-date="<?php echo $objItem->dateLastUse?>" data-date-format="mm-dd">
                                            <input type="hidden" name="txtCallback" value="<?php echo $callback; ?>"/>
                                            <input size="16"  class="form-control" type="text" name="txtDateLastUse" id="txtDateLastUse" value="<?php echo (new DateTime($objItem->dateLastUse))->format('m-d')?>">
						...
						<div class="col-lg-6">
								...
								<div class="form-group <?php echo getBahavioSession($company->type,"app_inventory_item","divControlExpiredOn","hidden",$objListCompanyPageSetting); ?>" >
									...
									<div class="col-lg-8">
										<div id="datepicker" class="input-group date" data-date="2014-01-30" data-date-format="yyyy-mm-dd">
											<input size="16"  class="form-control" type="text" name="txtRealStateDateExpired" id="txtRealStateDateExpired" value="<?php echo $objItem->realStateDateExpired; ?>" readonly="readonly" >
											<span class="input-group-addon"><i class="icon16 i-calendar-4"></i></span>
										</div>
									</div>
								</div>
						...
						<div class="row">
							...
							<div class="col-lg-6">
								...
								<div class="form-group								                       <?php echo getBehavio($company->type, "app_inventory_item", "fieldInmobiliaria", "hidden"); ?>">
										...
										<div class="col-lg-8">
											<textarea class="form-control" name="txtRealStateReferenceCondominio" id="txtRealStateReferenceCondominio" rows="5" placeholder="Escribe aquí..."><?php echo $objItem->realStateReferenceCondominio; ?></textarea>
										</div>
								</div>
					...
					<div class="tab-pane fade" id="sku">
						...
						<div class="row">
							<div class="col-lg-12">
								<table class="table table-bordered" id="tblItemSku">
									<thead>
									  <tr>
										<th>Sku</th>
										<th>Cantidad</th>
