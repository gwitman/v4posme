					...
					<div class="tab-pane fade in active" id="home">	
						...
						<div class="col-lg-6">
								...
								<div class="form-group">
									...
									<div class="col-lg-8">
										<img width="200px" height="70px" src="<?php echo base_url(); ?>/app_inventory_item/popup_add_renderimg/<?php echo $objItem->companyID; ?>/<?php echo $objComponent->componentID; ?>/<?php echo $objItem->itemID; ?>" />
									</div>
								</div>
