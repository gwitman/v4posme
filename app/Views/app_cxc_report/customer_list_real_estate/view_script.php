...
<script>				
	$(document).ready(function(){
		...
		$(document).on("click","#print-btn-report",function(){
			...
			if(!( startOn == "" || endOn == "" ) ){
				fnWaitOpen();
				window.location	= "<?php echo base_url(); ?>/app_cxc_report/customer_list_real_estate/"+
					"viewReport/true/startOn/"+startOn+"/endOn/"+endOn+
					"/showActivos/"+showActivos+"/warehouseID/"+warehouseID+
