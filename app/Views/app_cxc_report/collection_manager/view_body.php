                                    ...
                                    <div class="panel-body">
                                        <form class="form-horizontal pad15 pad-bottom0" role="form">
											<div class="form-group">
												<label class="col-lg-9 control-label" for="selectFilter">Colaborador</label>
												<div class="col-lg-3"> 
													<div class="col-lg-12">
														<input size="16"  class="form-control" type="text" name="txtEmployeeNumber" id="txtEmployeeNumber" value="">
													</div>												
												</div>
											</div>
                                        </form>
