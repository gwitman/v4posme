						...
						<div class="col-lg-12">
								<div class="panel panel-default">
                                    <div class="panel-heading">
                                        ...
                                        <h4>CONTRATO DEL DOCUMENTO DE CREDITO</h4>										
                                    ...
                                    <div class="panel-body">
                                        <form class="form-horizontal pad15 pad-bottom0" role="form">
											<div class="form-group">
												<label class="col-lg-9 control-label" for="selectFilter">Documento</label>
												<div class="col-lg-3"> 
													<div class="col-lg-12">
														<input size="16"  class="form-control" type="text" name="txtDocumentNumber" id="txtDocumentNumber" value="">
													</div>												
												</div>
											</div>
                                        </form>
