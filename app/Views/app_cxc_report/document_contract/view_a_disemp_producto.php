...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>/resource/css/style_table_report_printer.css">
		<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>/resource/css/style_table_report_printer.css" media="print">
	</head>
			...
			<table>
				<tbody >
					<tr>
						...
						solicite, a la orden del Sr(@) <b><?php echo $objPropietaryName->value;?></b> reconocid(@) con 
						cedula <b><?php echo $objPropietaryID->value;?></b> y con domicilio en
						<?php echo $objPropietaryAddress->value;?> casad(@), la suma de 
						...
						<?php echo $objFirstDetail["TipoCambio"];?> córdobas por cada dolar cuando se facturo  el o los productos con la referencia de factura <b><?php echo  $objFirstDetail["documentNumber"]; ?></b>.
						
						Esta factura fue emitida en concepto de: <b><?php echo  $objFirstDetail["Concepto"]; ?></b>.
						<br/>
						<br/>
						</td>						
					</tr>
					<tr>
						<td style="text-align:justify;font-size:small;font-family: 'Inconsolata', monospace;">
						El o los productos serán pagado en Dólares de los Estados Unidos de América, este valor se pagará en  <b><?php echo $objFirstDetail["term"]; ?> cuotas </b>
					...
					<tr>
						<td style="text-align:justify;font-size:small;font-family: 'Inconsolata', monospace;">
							...
							credito de el o los productos. Los testigos son: <br/><br/>
							...
							<b>291-120685-0000P</b> y con domicilio en la ciudad de Malpaisillo de la Policía Nacional 3C.E y 1/2C.S <br/><br/>
							...
							<br/>
							El o los productos me fueron entregados en su totalidad en mis manos y en buenas condiciones, en la casa de habitación 
