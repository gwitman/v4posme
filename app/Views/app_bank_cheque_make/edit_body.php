    ...
    <div id="email" class="col-lg-12">
        ...
        <div class="email-bar" style="border-left:1px solid #c9c9c9">
            <div class="btn-group pull-right">
                <a href="<?php echo base_url(); ?>/app_bank_cheque_make/add" class="btn btn-success" id="btnNuevo"><i class="icon16 i-checkmark-4"></i>Nuevo</a>
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                ...
                <h4>Emision De Cheque:#<span class="invoice-num"><?php echo $objTM->transactionNumber ?></span></h4>
            </div>
            <!-- /titulo de comprobante-->
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                <input type="hidden" id="txtCheckbookID" name="txtCheckbookID" value="<?= $objCheckbook->chequeID ?>">
                                                <input class="form-control" readonly id="txtCheckbookDescription" type="txtCheckbookDescription" value="<?= $objCheckbook->chequeNumber . " | " . $objCheckbook->name ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" readonly type="text" name="txtCheckbookCounterDescription" id="txtCheckbookCounterDescription" value="<?= $objTM->numberPhone ?: ""; ?>">
                                            <input type="hidden" name="txtCheckbookCounter" id="txtCheckbookCounter" value="<?= $objCheckbook->valueCurrent ?>">
                                            <input type="hidden" name="txtCheckbookCounterLimit" id="txtCheckbookCounterLimit" value="<?= $objCheckbook->valueFinal ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" type="text" name="txtReceiver" id="txtReceiver" value="<?= $objTM->reference4 ?>">
                                        </div>
                                    </div>
