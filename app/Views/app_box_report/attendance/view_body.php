                                        ...
                                        <form class="form-horizontal pad15 pad-bottom0" role="form">											
												...
												<div class="col-lg-6"> 
													<div class="col-lg-6">
															<div id="hourdatepicker" class="input-group "  >
																<input size="16"  class="form-control" type="text" name="txtHourStartOn" id="txtHourStartOn" value="00">
																<span class="input-group-addon"><i class="icon16 i-calendar-4"></i></span>
															</div>
													</div>
													<div class="col-lg-6">
											...
											<div class="form-group">
												...
												<div class="col-lg-6"> 
													...
													<div class="col-lg-6">
														<select name="txtFormat" id="txtFormat" class="select2">
											...
											<div class="form-group">
												<label class="col-lg-6 control-label" for="selectFilter">Medida</label>
												<div class="col-lg-6"> 
													<div class="col-lg-6">
													</div>
													<div class="col-lg-6">
														<select name="txtSize" id="txtSize" class="select2">
