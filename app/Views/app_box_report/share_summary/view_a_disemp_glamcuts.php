...
<html lang="en">
	...
	<body style="font-family:monospace;font-size:smaller;margin:0px 0px 0px 0px"> 
		...
		//Transformar Venta de Contado 		
		if($objSales)
		{
			$counteIndex = 0;
			for($counteIndex = 0 ; $counteIndex < count($objSales); $counteIndex++)
			{
				if( strtoupper($objSales[$counteIndex]["currencyName"])  == strtoupper( "Dolar") )
				{
					$objSales[$counteIndex]["totalDocument"] = $objSales[$counteIndex]["totalDocument"] / $objSales[$counteIndex]["exchangeRate"];
				}
			}
		}
...
-		$columnX 	= 2;
		...
		$configTotalesColumnsTotalDolares[0]["Width"] = $widthX;
		...
		$configTotalesColumnsTotalDolaresFirma[0]["Width"] = $widthX;
