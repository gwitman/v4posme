    ...
    <div id="email" class="col-lg-12">
        ...
        <div class="email-bar" style="border-left:1px solid #c9c9c9">
            <div class="btn-group pull-right">
                <a href="<?php echo base_url(); ?>/app_afx_fixedassent_input/add" class="btn btn-success" id="btnNuevo"><i class="icon16 i-checkmark-4"></i>Nuevo</a>
                <a href="<?php echo base_url(); ?>/app_afx_fixedassent_input/index" id="btnBack" class="btn btn-inverse"><i class="icon16 i-rotate"></i> Atras</a>
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                ...
                <h4>Entrada De Activo Fijo:#<span class="invoice-num"><?= $objTM->transactionNumber ?></span></h4>
            </div>
            <!-- /titulo de comprobante-->

            <!-- body -->
            <form id="form-new-fixedasset_input" name="form-new-fixedasset_input" class="form-horizontal" role="form">
                        ...
                        <div class="tab-pane fade in active" id="home">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-4 control-label" for="buttons">Area Asignada</label>
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-4 control-label" for="buttons">Proyecto Asignado</label>
                                        <div class="col-lg-8">
                                            <div class="input-group">
