				...
				<script>
					$(document).ready(function() {
						...
						$(document).on("click", "#btnAcept", function() {
							...
							$("#form-new-fixedasset_input").attr("action", "<?php echo base_url(); ?>/app_afx_fixedassent_input/save/edit");
						...
						$(document).on("click", "#btnClickArchivo", function() {
							window.open("<?php echo base_url() . "/core_elfinder/index/componentID/" . $objComponentFixedAssetInput->componentID . "/componentItemID/" . $objTM->transactionMasterID; ?>", "blanck");
						});
						...
						$(document).on("click", "#btnDelete", function() {
							fnShowConfirm("Confirmar..", "Desea eliminar este Registro...", function() {
								...
								$.ajax({
									...
									dataType: 'json',
									type: 'POST',
									url: "<?php echo base_url(); ?>/app_afx_fixedassent_input/delete",
									data: {
									...
									success: function(data) {
										...
										if (data.error) {
											...
											window.location = "<?php echo base_url(); ?>/app_afx_fixedassent_input/index";
										}
									},
						...
						$(document).on("click", "#btnPrinter", function() {
							fnWaitOpen();
							window.open("<?php echo base_url(); ?>" + "/" + "/app_afx_fixedassent_input/viewPrinterFormatoA4" + "/companyID/<?= $objTM->companyID; ?>/transactionID/<?= $objTM->transactionID; ?>/transactionMasterID/<?= $objTM->transactionMasterID; ?>", '_blank');
							fnWaitClose();
						});
