				...
				<?php 
					if($callback == "false")
					{
						?>
							...
							<a href="<?php echo base_url(); ?>/app_cxc_customer/viewPrinterCarnet/companyID/2/branchID/2/entityID/<?php echo $objCustomer->entityID; ?>" target="_blank" class="btn btn-primary" id="btnCarnet"><i class="icon16 i-pencil"></i> Carnet</a>
						...
						<div class="row">
							...
							<div class="col-lg-6">
								...
								<div class="form-group">
										...
										<div class="col-lg-8">
											<input class="form-control txt-numeric"  type="text"   name="txtLimitBalanceDol" id="txtLimitBalanceDol" value="<?php echo number_format($objCustomerCredit->balanceDol,2); ?>">												
										</div>
								</div>
								<div class="form-group">
						...
						<div class="row">		
							...
							<div class="col-lg-6">
								...
								<div class="form-group">
									...
									<div class="col-lg-8">
										<div class="input-group">
											<input type="hidden" id="txtCustomerIDReference" name="txtCustomerIDReference" value="<?php echo $objCustomerReferente != NULL ?  $objCustomerReferente->entityID : "";  ?>">
											<input class="form-control" readonly id="txtCustomerIDReferenceDescription" type="txtCustomerIDReferenceDescription" value="<?php echo $objCustomerReferente != null ? strtoupper($objCustomerReferente->customerNumber . " ". $objCustomerReferenteNatural->firstName . " ". $objCustomerReferenteNatural->lastName ) : ""; ?>">
