	...
	<div class="container-xxl flex-grow-1 container-p-y">
		...
		<div class="col-md-12 col-lg-12 mb-6">
			...
			<form id="frmPublic" role="form" action="<?= base_url(); ?>/app_form_public/save" method="POST" enctype="multipart/form-data">
				...
				<p>&nbsp;</p>
				<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Dirección/</span> ...</h4>
				<div class="card h-100">
					<div class="card-body">
						<div class="container-fluid">
							<div class="row">
								<div class="col-md-4 my-2 px-4">
									<label for="txtTransactionMasterReference18" class="col-form-label">Población</label>
									<select id="txtTransactionMasterReference18" name="txtTransactionMasterReference18" class="select2 form-select form-select-lg" data-allow-clear="true">
