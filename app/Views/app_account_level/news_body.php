												...
												<form id="form-new-account-level" name="form-new-rol" class="form-horizontal" role="form">
													<fieldset>		
														...
														<div class="form-group">
																...
																<div class="col-lg-2">
																	<input class="form-control"  type="text" name="txtSplit" id="txtSplit" value="">												
																</div>
														</div>
														...
														<div class="form-group">
																...
																<div class="col-lg-2">
																	<input class="form-control"  type="text" name="txtLengthTotal" id="txtLengthTotal" value="">												
																</div>
														</div>
														...
														<div class="form-group">
																...
																<div class="col-lg-2">
																	<input class="form-control"  type="text" name="txtLengthGroup" id="txtLengthGroup" value="">												
																</div>
														</div>
