...
class core_mysql_dump
{
    ...
    protected $dumpSettingsDefault = array(
        ...
        'databases' => false,
        'default-character-set' => core_mysql_dump::UTF8,
        'disable-keys' => true,
...
abstract class CompressMethod
{
    public static $enums = array(
        core_mysql_dump::NONE,
        core_mysql_dump::GZIP,
        core_mysql_dump::BZIP2,
        core_mysql_dump::GZIPSTREAM,
    );
