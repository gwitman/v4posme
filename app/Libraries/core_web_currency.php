...
class core_web_currency {
   ...
   function getCurrencyDefault($companyID){
	    ...
	    $moneyFuncionalName = $core_web_parameter->getParameter("ACCOUNTING_CURRENCY_NAME_FUNCTION",$companyID);
	    //Obtener Moneda
	    return $Currency_Model->get_rowName($moneyFuncionalName->value);
   }
   function getCurrencyReport($companyID){
	    $core_web_parameter = new core_web_parameter();
   		$Currency_Model = new Currency_Model();
	    $moneyFuncionalName = $core_web_parameter->getParameter("ACCOUNTING_CURRENCY_NAME_REPORT",$companyID);
	    //Obtener Moneda
	    return $Currency_Model->get_rowName($moneyFuncionalName->value);
   }
   function getCurrencyExternal($companyID){
	    $core_web_parameter = new core_web_parameter();
		$Currency_Model = new Currency_Model();
		$moneyFuncionalName = $core_web_parameter->getParameter("ACCOUNTING_CURRENCY_NAME_EXTERNAL",$companyID);
		//Obtener Moneda
		return $Currency_Model->get_rowName($moneyFuncionalName->value);
	}
   function getCurrencyName($name){
	    ...
	    //Obtener Moneda
	    return $Currency_Model->get_rowName($name);
   }
   ...
   function getRatio($companyID,$dateRatio,$quantity,$currencyID,$targetCurrencyID){   		
   		$ExchangeRate_Model = new ExchangeRate_Model();
		...
		$objConvertionSource = $ExchangeRate_Model->get_rowByPK($companyID,$dateRatio,$objConvertionDefault->currencyID,$currencyID);
		...
		$objConvertionTarget = $ExchangeRate_Model->get_rowByPK($companyID,$dateRatio,$objConvertionDefault->currencyID,$targetCurrencyID);
