...
abstract class elFinderVolumeDriver {
	...
	public function mount(array $opts) {
		...
		$finfo_open  = finfo_open(FILEINFO_MIME);
		$finfo_open2 = @finfo_file($finfo_open,__FILE__);
		$explod      = explode(";",$finfo_open2);
		$arrr_shift  = array_shift($explod);
		$preg_match  = preg_match($regexp,$arrr_shift);
