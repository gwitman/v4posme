    ...
    <div id="email" class="col-lg-12">
        ...
        <div class="email-bar" style="border-left:1px solid #c9c9c9">
            <div class="btn-group pull-right">
                <a href="<?php echo base_url(); ?>/{nombre_controlador}/index" id="btnBack" class="btn btn-inverse" ><i class="icon16 i-rotate"></i> Atras</a>
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                ...
                <h4>RECIBO:#<span class="invoice-num">00000000</span></h4>
            </div>
            <!-- /titulo de comprobante-->
