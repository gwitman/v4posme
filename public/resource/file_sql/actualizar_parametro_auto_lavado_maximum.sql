...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "4810510940000F" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "TEL: 5800-8426" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Esquina Victor miranda 120m al norte" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE tb_company SET 
	NAME = 'Auto Lavado Maximum' , address = 'Esquina Victor miranda 120m al norte' ,
	flavorID = 679 /*usuarioID*/,type='maximum'  , abreviature='demo'
WHERE 
