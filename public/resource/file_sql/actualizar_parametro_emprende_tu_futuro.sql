...
UPDATE  tb_company_parameter,tb_parameter SET
    tb_company_parameter.value = "Mercedes del Carmen Alvarez Reyes"
WHERE
    tb_company_parameter.parameterID = tb_parameter.parameterID AND
...
UPDATE  tb_company_parameter,tb_parameter SET
    tb_company_parameter.value = "TEL: 5809-8869"
WHERE
    tb_company_parameter.parameterID = tb_parameter.parameterID AND
...
UPDATE  tb_company_parameter,tb_parameter SET
    tb_company_parameter.value = "Del porton de la iglesia el calvario 180v. al norte."
WHERE
    tb_company_parameter.parameterID = tb_parameter.parameterID AND
...
UPDATE tb_company SET
	  NAME = 'Emprende YA tu futuro' , address = 'Del porton de la iglesia el calvario 180v. al norte.' ,
