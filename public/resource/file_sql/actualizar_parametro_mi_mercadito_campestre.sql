/*BD: 	dbuipnighhqvc5:parametro_mi_mercadito_campestre*/
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "2811803890004R" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "5756-9044" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Malpaisillo, Contiguo al restaurante el Campestre." 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
