...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Lisset Margarita Ortega Toledo" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "362-190186-0001C" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "TEL: 8645-1614" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Escuela Juan María 3 cuadras al norte, 10 varas al Oeste " 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE tb_company SET 
	NAME = 'Farmacia San Rafael' , address = 'Escuela Juan María 3 cuadras al norte, 10 varas al Oeste ' ,
	flavorID = 897 /*usuarioID*/,type='san_rafael'  , abreviature='demo'
WHERE 
