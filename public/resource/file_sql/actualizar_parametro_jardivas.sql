/*BD: 	dby7olptyr5gpg :parametro_jardivas*/
/*SERVIDOR:		siteground*/
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Leandro Josue Vasquez Escorcia" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "161-190606-1004P" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "5889-8783" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Esteli, Bo. Cld Dinamarca Porton Inpru 2c.n y 1c.o." 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE tb_company SET 
	NAME = 'Vasquez Jardines y Paisajes' , address = 'Esteli, Bo. Cld Dinamarca Porton Inpru 2c.n y 1c.o.' ,
	flavorID = 1067 /*usuarioID*/,type='jardivas'  , abreviature='demo'
WHERE 
