...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Julio Cesar Cruz Arevalo" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "161-110103-1002D" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "TEL: 8523-2515" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Costado Noroeste plaza parque 1/2c al sur" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE tb_company SET 
	NAME = 'LATTEGO' , address = 'Costado Noroeste plaza parque 1/2c al sur' ,
	flavorID = 833 /*usuarioID*/,type='lattego'  , abreviature='demo'
WHERE 
