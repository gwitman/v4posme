/*BD: 	dbyakujmlvkbhw:parametro_comedor_amver*/
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "8208-2445" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Del pali proquinsa media cuadra al este, mano izquierda." 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE tb_company SET 
	NAME = 'Comedor Amver' , address = 'Del pali proquinsa media cuadra al este, mano izquierda.' ,
	flavorID = 1136 /*usuarioID*/,type='amver'  , abreviature='demo'
WHERE 
