...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "fc0b0a5d-6bc3-4ba0-be78-45bd29690550" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Jennry" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "J0310000066388" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "TEL: 8920-2130" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Frente a la entrada principal de Iglesia la Merced" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE tb_company SET 
	NAME = 'Compu MATT' , address = 'Frente a la entrada principal de Iglesia la Merced,' ,
	flavorID = 553 /*usuarioID*/,type='compu_matt'
WHERE 
