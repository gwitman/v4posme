...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Francisco Narvaez" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "291-290192-0001G" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "TEL: 8525 2915" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Iglesia Católica media cuadra al sur, Malpaisillo." 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE tb_company SET 
	NAME = 'FERRETERIA NARVAEZ #2' , address = 'Iglesia Católica media cuadra al sur, Malpaisillo.' ,
	flavorID = 951 /*usuarioID*/,type='ferreteriaNarvaez'  , abreviature='demo'
WHERE 
