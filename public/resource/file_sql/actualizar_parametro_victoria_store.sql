...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "8539-1856 || 8289-5220" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Doribel Salgado Sotelo" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "281-270291-0000P" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
