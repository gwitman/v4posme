/*BD: 	dbg8efetl2xywc:parametro_rb_moto_store*/
...
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
	tb_parameter.name = "CORE_BACKUP_ENABLE";## Hacer backup diarios
...
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
	tb_parameter.name = "INVOICE_URL_PRINTER_OPCION3";## URLs PARA LA IMPRESION DE FACTURA 	
	
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "app_invoice_billing/viewRegisterFormatoPaginaNormalA4Opcion1DB" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "001-290900-1049E" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "CLARO 8412-6271 TIGO: 8885-8549" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Del Ganbei Miguel Gutiérrez 2 cuadras hacia arriba sobre la marginal, módulo celeste, Managua." 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE tb_company SET 
	NAME = 'RB Moto Store' , address = 'Del Ganbei Miguel Gutiérrez 2 cuadras hacia arriba sobre la marginal, módulo celeste, Managua.' ,
	flavorID = 1157 /*usuarioID*/,type='rbMotoStore'  , abreviature='rbMotoStore'
WHERE 
