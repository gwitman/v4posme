...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Gustavo Adolfo Castillo Espinoza" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "2811907841000E" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "TEL: 8796-6512" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Cayetano Munguía, 50 varas al Norte - León, Nicaragua" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE tb_company SET 
	NAME = 'AGRONIC' , address = 'Cayetano Munguía, 50 varas al Norte - León, Nicaragua' ,
	flavorID = 798 /*usuarioID*/,type='agronic'  , abreviature='demo'
WHERE 
