...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Esneyder Rueda Urrego" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "1092008015" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "J0910000137096" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "(505) 2713-3469 / (505) 8621-5755" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "De dónde fue Profamilia 1 cuadra al Este y 75 varas al Sur. Esteli, Nicaragua" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
