/*BD: 	posme:parametro_comercial_san_jose*/
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Griselda Silvana Balmaceda Enrique" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "291-031185-0000C" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "TEL: 8492-3927" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Centro de salud, 25v. al Oeste" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
