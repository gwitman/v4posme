...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Onelly Salmeron Caballero" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "google@yahoo.com" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "290-100385-0000X" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "TEL: 5855-4842" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Calle Real de Tolapa, Entrada al Colegio Silon" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE tb_company SET 
	NAME = 'FERRETERIA SALMERON' , address = 'Calle Real de Tolapa, Entrada al Colegio Silon' ,
	flavorID = 461,type='ferwelle'
WHERE 
