/*BD: 	dbnqvizx3xth09:parametro_moto_repuesto_blandon*/
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "TEL: 8709-7772" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "De la bloquera Howard media cuadra arriba, frente a importaciones Betanco, Pista Mayoreo." 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
