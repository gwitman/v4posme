...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Roxana Galo" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "TEL: 8337-7955" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Click Food Park" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE tb_company SET 
	NAME = 'Dfrutas' , address = 'Click Food Park' ,
	flavorID = 680 /*usuarioID*/,type='dfrutas'  , abreviature='demo'
WHERE 
