...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "https://posme.net/v4posme/agenda/public/app_config_noti/eventgoogleadd" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "12.95" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE tb_company SET 
	NAME = 'posMe Agenda' , address = 'Donde fue aserrio santa fe, 2c abajo 15v.sur' ,
