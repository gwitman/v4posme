...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Winston Rostran / Lester Rostran" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "2811706890003H" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "TEL: 8885-5093" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Cayetano Munguia 1 cuadra al sur 1/2 cuadra arriba, León." 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE tb_company SET 
	NAME = 'Taller Rostran' , address = 'Cayetano Munguia 1 cuadra al sur 1/2 cuadra arriba, León.' ,
	flavorID = 847 /*usuarioID*/,type='taller_rostran'  , abreviature='taller_rostran'
WHERE 
