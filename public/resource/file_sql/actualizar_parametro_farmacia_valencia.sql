...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "flc_farmacia_valencia" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "8835-5515" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Clinica Miguel Valencia" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE tb_company SET 
	NAME = 'Farmacia Miguel Valencia' , address = 'Clinica Miguel Valencia' 
WHERE 
