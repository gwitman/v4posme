/*BD: 	dbjlozx1lthb0y:parametro_black_de_poneloya*/
/*SERVIDOR:		siteground*/
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Juan Jose Estrada Chevez" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "TEL: 8750-5456" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Costa azul 2cuadras abajo" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE tb_company SET 
	NAME = 'El BLACK de poneloya' , address = 'Costa azul 2cuadras abajo' ,
	flavorID = 1017 /*usuarioID*/,type='default'  , abreviature='demo'
WHERE 
