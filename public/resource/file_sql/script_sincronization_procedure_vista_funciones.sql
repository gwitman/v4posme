...
ALTER TABLE `tb_item` CHARACTER SET = utf8, COLLATE = utf8_general_ci;

DROP TRIGGER `check_quantity_insert_tb_item`;

DROP TRIGGER `check_quantity_update_tb_item`;

ALTER TABLE `tb_item` MODIFY COLUMN `name` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' AFTER `barCode`;

ALTER TABLE `tb_item` MODIFY COLUMN `description` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER `name`;

ALTER TABLE `tb_item` MODIFY COLUMN `reference3` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER `reference2`;

ALTER TABLE `tb_item` MODIFY COLUMN `realStateLinkYoutube` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER `realStatePlanReference`;

ALTER TABLE `tb_item` MODIFY COLUMN `realStateLinkPaginaWeb` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER `realStateLinkYoutube`;

ALTER TABLE `tb_item` MODIFY COLUMN `realStateLinkPhontos` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER `realStateLinkPaginaWeb`;

ALTER TABLE `tb_item` MODIFY COLUMN `realStateLinkGoogleMaps` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER `realStateLinkPhontos`;

ALTER TABLE `tb_item` MODIFY COLUMN `realStateLinkOther` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER `realStateLinkGoogleMaps`;

ALTER TABLE `tb_item` MODIFY COLUMN `realStateStyleKitchen` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER `realStateLinkOther`;

ALTER TABLE `tb_item` MODIFY COLUMN `realStateReferenceUbicacion` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER `realStateRoomBatchServices`;

ALTER TABLE `tb_item` MODIFY COLUMN `realStateReferenceZone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER `realStateReferenceUbicacion`;

ALTER TABLE `tb_item` MODIFY COLUMN `realStateReferenceCondominio` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER `realStateReferenceZone`;

ALTER TABLE `tb_item` MODIFY COLUMN `realStatePhone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER `realStateGerenciaExclusive`;

ALTER TABLE `tb_item` MODIFY COLUMN `realStateEmail` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER `realStatePhone`;

CREATE DEFINER =  CURRENT_USER  TRIGGER `check_quantity_insert_tb_item` BEFORE INSERT ON `tb_item` FOR EACH ROW BEGIN
...
CREATE DEFINER =  CURRENT_USER  TRIGGER `check_quantity_update_tb_item` BEFORE UPDATE ON `tb_item` FOR EACH ROW BEGIN
	 DECLARE dummy,baddata INT;  
    SET baddata = 0;  
...
ALTER TABLE `tb_item_config_loto` CHARACTER SET = utf8, COLLATE = utf8_general_ci;

DROP TRIGGER `check_quantity_insert_tb_item_warehouse`;

DROP TRIGGER `check_quantity_update_tb_item_warehouse`;

CREATE DEFINER =  CURRENT_USER  TRIGGER `check_quantity_insert_tb_item_warehouse` BEFORE INSERT ON `tb_item_warehouse` FOR EACH ROW BEGIN
	DECLARE dummy,baddata INT;
	SET baddata = 0;
...
CREATE DEFINER =  CURRENT_USER  TRIGGER `check_quantity_update_tb_item_warehouse` BEFORE UPDATE ON `tb_item_warehouse` FOR EACH ROW BEGIN
	 DECLARE dummy,baddata INT;  
    SET baddata = 0;  
...
ALTER TABLE `tb_log_messeger` CHARACTER SET = utf8, COLLATE = utf8_general_ci;

ALTER TABLE `tb_log_messeger` MODIFY COLUMN `errtype` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL AFTER `errno`;

ALTER TABLE `tb_log_messeger` MODIFY COLUMN `errstr` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL AFTER `errtype`;

ALTER TABLE `tb_log_messeger` MODIFY COLUMN `errfile` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL AFTER `errstr`;

ALTER TABLE `tb_log_messeger` MODIFY COLUMN `user_agent` varchar(450) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL AFTER `errline`;

ALTER TABLE `tb_log_messeger` MODIFY COLUMN `ip_address` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' AFTER `user_agent`;

ALTER TABLE `tb_naturales` MODIFY COLUMN `firstName` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER `entityID`;

ALTER TABLE `tb_remember` MODIFY COLUMN `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER `companyID`;

ALTER TABLE `tb_transaction_master_denomination` CHARACTER SET = utf8, COLLATE = utf8_general_ci;

ALTER TABLE `tb_transaction_master_denomination` MODIFY COLUMN `reference1` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER `ratio`;

ALTER TABLE `tb_transaction_master_denomination` MODIFY COLUMN `reference2` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER `reference1`;

DROP PROCEDURE IF EXISTS `_Navicat_Temp_Stored_Proc`;

CREATE DEFINER =  CURRENT_USER  PROCEDURE `_Navicat_Temp_Stored_Proc`(IN `prCompanyID` INT, IN `prBranchID` INT, IN `prLoginID` INT, IN `prCreatedIn` VARCHAR(50), IN `prTocken` VARCHAR(250), IN `prPeriodID` INT, IN `prCycleID` INT, OUT `prCodeError` INT, OUT `prMessageResult` VARCHAR(250))
  MODIFIES SQL DATA 
...
CREATE DEFINER =  CURRENT_USER  FUNCTION `fn_calculate_exchange_rate`(`prCompanyID` INT, `prDate` DATE, `prCurrencySourceID` INT, `prCurrencyTargetID` INT, `prValorToConvert` DECIMAL(21,11))
...
CREATE DEFINER =  CURRENT_USER  FUNCTION `fn_get_access_ready`(`prCompanyID` INT, `prUserID` INT, `prElementID` INT, `prRowCreatedBy` INT, `prRowCreatedAt` INT)
 RETURNS int(11)
  DETERMINISTIC
...
CREATE DEFINER =  CURRENT_USER  FUNCTION `fn_get_provider_id`(`prCompanyID` INT, `prUserID` INT)
 RETURNS int(11)
BEGIN
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_accounting_calculate_utility`(IN `prCompanyID` INT, IN `prBranchID` INT, IN `prLoginID` INT, IN `prTocken` VARCHAR(250), IN `prPeriodID` INT, IN `prCycleID` INT, OUT `prUtility` DECIMAL(18,8))
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_accounting_checkaccount_to_delete`(IN `prCompanyID` INT, IN `prBranchID` INT, IN `prLoginID` INT, IN `prAccountID` INT, IN `prApp` VARCHAR(50), OUT `prResultMessage` VARCHAR(300), OUT `prResultCode` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_accounting_closed_cycle`(IN `prCompanyID` INT, IN `prBranchID` INT, IN `prLoginID` INT, IN `prCreatedIn` VARCHAR(50), IN `prTocken` VARCHAR(250), IN `prPeriodID` INT, IN `prCycleID` INT, OUT `prCodeError` INT, OUT `prMessageResult` VARCHAR(250))
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
  COMMENT 'Procedimiento para Cerrar un Ciclo Contable'
LBL_PROCEDURE:
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_accounting_financial_reason`(IN `prCompanyID` INT, IN `prBranchID` INT, IN `prLoginID` INT, IN `prTocken` VARCHAR(50), IN `prPeriodID` INT, IN `prCycleID` INT, IN `prMonthOnly` INT, IN `prParameterName` VARCHAR(50), OUT `prResult` DECIMAL(18,5))
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_accounting_get_history_balance_by_account`(IN `prCompanyID` INT, IN `prAccountID` INT)
  SQL SECURITY INVOKER
BEGIN	
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_accounting_get_report_auxiliar_account`(IN `prCompanyID` INT, IN `prPeriodID` INT, IN `prCycleIDStart` INT, IN `prCycleIDEnd` INT, IN `prAccountID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_accounting_get_report_auxiliar_mov_tipo_comprobantes`(IN `prCompanyID` INT, IN `prJournalTypeID` INT, IN `prStartOn` DATETIME, IN `prEndOn` DATETIME, IN `prExcludeSystem` INT, IN `prStringContainer` VARCHAR(500), IN `prClassID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_accounting_get_report_balance_general`(IN `prCompanyID` INT, IN `prBranchID` INT, IN `prLoginID` INT, IN `prTocken` VARCHAR(250), IN `prPeriodID` INT, IN `prCycleID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_accounting_get_report_balanza_de_comprobacion`(IN `prCompanyID` INT, IN `prPeriodID` INT, IN `prCycleID` INT, IN `prClassID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_accounting_get_report_cash_flow`(IN `prCompanyID` INT, IN `prTokenID` VARCHAR(50), IN `prUserID` INT, IN `prCycleID` INT, IN `prPeriodID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
BEGIN
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_accounting_get_report_catalogo_de_cuenta`(IN `prCompanyID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_accounting_get_report_estado_resultado`(IN `prCompanyID` INT, IN `prBranchID` INT, IN `prLoginID` INT, IN `prTocken` VARCHAR(250), IN `prPeriodID` INT, IN `prCycleID` INT, IN `prClassID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_accounting_get_report_presupuestory`(IN `prCompanyID` INT, IN `prPeriodID` INT, IN `prCycleID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
BEGIN
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_accounting_get_report_razon_financial`(IN `prCompanyID` INT, IN `prBranchID` INT, IN `prLoginID` INT, IN `prTokenID` VARCHAR(50), IN `prPeriodID` INT, IN `prCycleID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_accounting_import_account`()
  MODIFIES SQL DATA 
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_accounting_initialize_account_tmp`(IN `prCompanyID` INT, IN `prBranchID` INT, IN `prLoginID` INT, IN `prTocken` VARCHAR(250), IN `prPeriodID` INT, IN `prCycleID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_accounting_mayorizate_account`(IN `prCompanyID` INT, IN `prPeriodID` INT, IN `prCycleID` INT, IN `prAccountID` INT, IN `prBalance` DECIMAL(19,8), IN `prDebit` DECIMAL(19,8), IN `prCredit` DECIMAL(19,8))
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_accounting_mayorizate_account_tmp`(IN `prCompanyID` INT, IN `prBranchID` INT, IN `prLoginID` INT, IN `prTocken` VARCHAR(250), IN `prAccountID` INT, IN `prBalance` DECIMAL(19,8), IN `prDebit` DECIMAL(19,8), IN `prCredit` DECIMAL(19,8), IN `prBalanceEnd` DECIMAL(19,8))
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_accounting_mayorizate_cycle`(IN `prCompanyID` INT, IN `prBranchID` INT, IN `prLoginID` INT, IN `prPeriodID` INT, IN `prCycleID` INT, OUT `prResult` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_accounting_templated_to_journal`(IN `prCompanyID` INT, IN `prBranchID` INT, IN `prLoginID` INT, IN `prApp` VARCHAR(50), IN `prJournalEntryTemplated` INT, INOUT `prJournalEntryResult` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_accounting_transaction_to_journal`(IN `prCompanyID` INT, IN `prBranchID` INT, IN `prLoginID` INT, IN `prTransactionID` INT, IN `prSourceName` VARCHAR(50), IN `prResult` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_box_closed_box`(IN prUserID INT, 
	IN prBranchID INT,
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_box_get_report_abonos`(IN `prUserID` INT, IN `prTokenID` VARCHAR(150), IN `prCompanyID` INT, IN `prAuthorization` INT, IN `prStartOn` DATETIME, IN `prEndOn` DATETIME, 
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_box_get_report_attendance`(IN `prUserID` int,IN `prTokenID` varchar(150),IN `prCompanyID` int,IN `prAuthorization` int,IN `prStartOn` datetime,IN `prEndOn` datetime,IN `prUserIDFilter` int)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_box_get_report_closed`(IN `prUserID` int,IN `prTokenID` varchar(150),IN `prCompanyID` int,IN `prAuthorization` int,IN `prStartOn` datetime,IN `prEndOn` datetime,IN `prUserIDFilter` int)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
  COMMENT 'lista de abonos de los clientes'
BEGIN
 ...
 where 
	...
	#Calcular la forma de pago en efectivo Cordoba
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_box_get_report_closed_glamcuts`(IN `prUserID` int,IN `prTokenID` varchar(150),IN `prCompanyID` int,IN `prAuthorization` int,IN `prStartOn` datetime,IN `prEndOn` datetime,IN `prUserIDFilter` int)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
  COMMENT 'lista de abonos de los clientes'
BEGIN
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_box_get_report_closed_gym`(IN `prUserID` int,IN `prTokenID` varchar(150),IN `prCompanyID` int,IN `prAuthorization` int,IN `prStartOn` datetime,IN `prEndOn` datetime,IN `prUserIDFilter` int)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
  COMMENT 'lista de abonos de los clientes'
BEGIN
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_box_get_report_closed_operation`(IN `prUserID` INT, IN `prTokenID` VARCHAR(150), IN `prCompanyID` INT, IN `prUserBoxID` INT, IN `prStartOn` DATETIME, IN `prEndOn` DATETIME)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
SELECT 
  ...
  '' as Categoria,
  tc.name as ESTADO,
  -- Asignar MonedaLocal y MonedaExt según currencyID
  CASE 
...
WHERE 
  tm.transactionID = 19 /*FACTURAS*/ and 
  tm.isActive = 1 and 
  ws.aplicable = 1 and 
  tm.createdOn BETWEEN prStartOn AND prEndOn  and 
  (
...
INNER JOIN tb_currency cur1 on tm.currencyID = cur1.currencyID
INNER JOIN tb_currency cur2 on tm.currencyID2 = cur2.currencyID
WHERE tm.transactionID = 23/*ABONOS*/ and tm.isActive = 1 and ws.aplicable = 1
...
WHERE 
  tm.transactionID = 29 /*ingreso a caja*/ and 
...
FROM 
  ...
  LEFT JOIN tb_currency cur1 on tm.currencyID = cur1.currencyID
  LEFT JOIN tb_currency cur2 on tm.currencyID2 = cur2.currencyID
WHERE tm.transactionID = 30/*EG CAJA*/ and tm.isActive = 1 and ws.aplicable = 1
and tm.createdOn BETWEEN prStartOn AND prEndOn
and 
  (
    (caja_usu.userID = prUserBoxID and prUserBoxID != 0 )
...
WHERE 
  tm.transactionID= 38/*GASTOS*/ and 
  tm.isActive = 1 and 
  ws.aplicable = 1 and 
  tm.createdOn BETWEEN prStartOn AND prEndOn
and 
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_box_get_report_input_cash`(IN `prUserID` INT, IN `prTokenID` VARCHAR(150), IN `prCompanyID` INT, IN `prAuthorization` INT, IN `prStartOn` DATE, IN `prEndOn` DATE, IN `prUserIDFilter` INT , IN prConceptFilter VARCHAR(150) ,IN `prBranchID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_box_get_report_output_cash`(IN `prUserID` INT, IN `prTokenID` VARCHAR(150), IN `prCompanyID` INT, IN `prAuthorization` INT, IN `prStartOn` DATE, IN `prEndOn` DATE, IN `prUserIDFilter` INT,IN prConceptFilter VARCHAR(150) ,IN `prBranchID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
  COMMENT 'listado de ingresos y egresos de efectivo de la caja'
BEGIN
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_box_get_report_reconciliation_deposit`(IN `prUserID` INT, IN `prTokenID` VARCHAR(50), IN `prCompanyID` INT, IN `prEmployeeCode` VARCHAR(50),prStartOn DATETIME , prEndOn DATETIME)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
BEGIN
	declare varDate date;
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_collection_get_report_commision_provider`(IN `prUserID` INT, IN `prTokenID` VARCHAR(50), IN `prCompanyID` INT, IN `prStart` DATETIME, IN `prEnd` DATETIME, IN `prProviderID` INT)
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_collection_get_report_customer`(IN `prUserID` INT, IN `prToken` VARCHAR(50), IN `prCompanyID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_collection_get_report_detalle_transaction`(IN `prCompanyID` INT, IN `prBranchID` INT, IN `prLoginID` INT, IN `prTokenID` VARCHAR(50), IN `prPeriodID` INT, IN `prCycleID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_collection_get_report_document_credit`(IN `prCompanyID` INT, IN `prTokenID` VARCHAR(50), IN `prUserID` INT, IN `prDocumentNumber` VARCHAR(50))
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
BEGIN
	...
	from 
        ...
        -- Aumentar el contador para evitar bucle infinito
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_collection_get_report_documents_credit`(IN `prCompanyID` INT, IN `prTokenID` VARCHAR(50), IN `prUserID` INT, IN prDate DATETIME)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
BEGIN
	DECLARE varMin DATETIME;
  ...
  DECLARE sql_query VARCHAR(10000);
	...
	#Lista de abonos con sus fechas 
	DROP TEMPORARY TABLE IF EXISTS tbl_abonos_temp;
	CREATE TEMPORARY TABLE tbl_abonos_temp AS
	select 
	...
	#Inicializar todos los documentos con sus fechas
	...
	#Inicializar los abonos por fecha
	UPDATE 
		tbl_document_temp d
		...
		#Pivot Resultados
    #Generar lista de fechas únicas como columnas
		SELECT 
				GROUP_CONCAT(
						CONCAT(
    ...
    #Preparar y ejecutar el SQL dinámico		
		set @sql = sql_query;
		prepare stmt1 from @sql;
		execute stmt1;
	...
	select 
		...
		(
				...
				where 
					s_td.isActive = 1 and 
					s_t.isActive = 1 and 
					s_t.transactionID = 23 /*abonos*/ and 
	...
	WHERE 
		...
		d.isActive = 1 and 
		usu.isActive = 1 and 
		usu.userID not in ( 2 /*superadmin*/ , 666 /*admin web creditaguil*/)
	order by 
		22 
	;
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_collection_get_report_summary_credit`(IN `prCompanyID` INT, IN `prTokenID` VARCHAR(50), IN `prUserID` INT, IN prDate DATETIME)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
BEGIN
	DECLARE varMin DATETIME;
	...
	WHERE 
		...
		u.userID != 2 and 
		u.employeeID > 0 and 
		u.userID not in ( 2 /*superadmin*/ , 666 /*admin web creditaguil*/);
		
	
	#Obtener el numero de clientes por usuario actuales 
	UPDATE 
		...
		JOIN (
			...
			where 
				...
				cu.entityID in (
							...
							where 
								sub_d.statusID = 77 /*registrado*/ and 
								sub_d.isActive = 1 
			)
			group by 
				usu.nickname 
	...
	#Obtener el numero de creditos activos 
	UPDATE 
		tbl_user_data_temp  d 
		JOIN (
			select 
	...
	#Obtener el monto en cartera por usuario + intest 
	UPDATE 
		tbl_user_data_temp  d 
		JOIN (
			select 
	...
	#Obtener el monto en cartera por usuario  solo capital 
	UPDATE 
		tbl_user_data_temp  d 
		JOIN (
			select 
	...
	#Obtener el numero de clientes cancelados el dia actual
	UPDATE 
		tbl_user_data_temp  d 
		JOIN (
			select 
			...
			where 
				...
				cu.entityID not in (
					...
					where 
						dd.isActive = 1 and 
						dd.statusID = 77 /*REGISTRADOS*/ 
				)  /*cliente que no tiene credito*/ and 
				cu.entityID in (
					select 
						tm.entityID 
					from 
					...
					where 
						tm.isActive = 1 and 
						tm.transactionID = 23 /*abono*/ and 
						tm.transactionOn  between 
									DATE_SUB(DATE_SUB(NOW(), INTERVAL 6 HOUR), INTERVAL 1 DAY) AND   
									DATE_SUB(NOW(), INTERVAL 6 HOUR) /*abonos de los ultimos 7 dias*/
				) /*cancelacion en los ultimos 7 dias */
			group by 
				usu.nickname 
		) o on 
				d.nickname = o.nickname 
	...
	#Obtener el numero de clientes cancelados acumulados
	UPDATE 
		tbl_user_data_temp  d 
		JOIN (
			select 
	...
	#Obtener el numero de clientes nuevos  
	UPDATE 
		tbl_user_data_temp  d 
		JOIN (
			select 
			...
			where 
				...
				cu.createdOn between 
						DATE_SUB(DATE_SUB(NOW(), INTERVAL 6 HOUR), INTERVAL 1 DAY) AND   
						DATE_SUB(NOW(), INTERVAL 6 HOUR) /*CLIENTES NUEVOS EN LOS ULTIMOS  7 DIAS */
			group by 
				usu.nickname 
		) o on 
				d.nickname = o.nickname 
	...
	#Obtener el numero de clientes recuperados 
	UPDATE 
		tbl_user_data_temp  d 
		JOIN (
			select 
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_concept_helper_billing`(IN `prCompanyID` INT, IN `prTransactionID` INT, IN `prTransactionMasterID` BIGINT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_concept_helper_calendarpay`(IN `prCompanyID` INT, IN `prTransactionID` INT, IN `prTransactionMasterID` BIGINT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
BEGIN
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_concept_helper_cancelinvoice`(IN `prCompanyID` INT, IN `prTransactionID` INT, IN `prTransactionMasterID` BIGINT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_concept_helper_input_unpost`(IN `prCompanyID` INT, IN `prTransactionID` INT, IN `prTransactionMasterID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_concept_helper_other_input`(IN `prCompanyID` INT, IN `prTransactionID` INT, IN `prTransactionMasterID` BIGINT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_concept_helper_other_output`(IN `prCompanyID` INT, IN `prTransactionID` INT, IN `prTransactionMasterID` BIGINT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
  COMMENT 'Procediminento que se utiliza para calcular los conceptos de la transaccion de otras salidas de inventario'
BEGIN
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_concept_helper_provider`(IN `prCompanyID` INT, IN `prTransactionID` INT, IN `prTransactionMasterID` BIGINT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_concept_helper_returns_provider`(IN `prCompanyID` INT, IN `prTransactionID` INT, IN `prTransactionMasterID` BIGINT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_concept_helper_salaryadvance`(IN `prCompanyID` INT, IN `prTransactionID` INT, IN `prTransactionMasterID` BIGINT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_concept_helper_share`(IN `prCompanyID` INT, IN `prTransactionID` INT, IN `prTransactionMasterID` BIGINT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_concept_helper_sharecapital`(IN `prCompanyID` INT, IN `prTransactionID` INT, IN `prTransactionMasterID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_core_get_exchange_rate`(IN `prCompanyID` INT, IN `prDate` DATE, IN `prCurrencySource` VARBINARY(250), IN `prCurrencyTarget` VARBINARY(250), OUT `prExchangeRate` DECIMAL(18,8))
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_core_get_indicators`(IN `prCompanyID` INT, IN `prBranchID` INT, IN `prLoginID` INT, IN `prTokenID` VARCHAR(50), IN `prPeriodID` INT, IN `prCycleID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_core_get_next_number`(IN `prCompanyID` INT, IN `prComponent` VARBINARY(250), IN `prBranchID` INT, IN `prComponentItemID` INT, OUT `prNumber` VARCHAR(250))
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_core_get_parameter_value`(IN `prCompanyID` INT, IN `prParameter` VARBINARY(250), OUT `prValue` VARCHAR(250))
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_core_get_workflow_stage_init`(IN `prCompanyID` INT, IN `prTable` VARBINARY(250), IN `prField` VARBINARY(250), OUT `prWorkflowStageInit` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_cxc_get_report_certificate_of_grades`(IN `prCompanyID` INT, IN `prTokenID` VARCHAR(50), IN `prUserID` INT,  IN `prGrado` int, IN `prYear` INT , IN prCustomerID INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_cxc_get_report_collection_manager`(IN `prUserID` INT, IN `prTokenID` VARCHAR(50), IN `prCompanyID` INT, IN `prEmployeeCode` VARCHAR(50),prStartOn DATETIME , prEndOn DATETIME)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
BEGIN
	declare varDate date;
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_cxc_get_report_customer_credit`(IN `prUserID` INT, IN `prTokenID` VARCHAR(50), IN `prCompanyID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_cxc_get_report_customer_credit_by_user`(IN `prUserID` INT, IN `prTokenID` VARCHAR(50), IN `prCompanyID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
  COMMENT 'cartera de credito diferenciada por moneda'
BEGIN
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_cxc_get_report_customer_credit_dolares`(IN `prUserID` INT, IN `prTokenID` VARCHAR(50), IN `prCompanyID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_cxc_get_report_customer_expensas`(IN `prUserID` INT, IN `prTokenID` VARCHAR(50), IN `prCompanyID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
BEGIN
	select 
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_cxc_get_report_customer_list`(IN `prUserID` INT, IN `prTokenID` VARCHAR(50), IN `prCompanyID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_cxc_get_report_customer_pay`(IN `prCompanyID` INT, IN `prTokenID` VARCHAR(50), IN `prUserID` INT, IN `prCustomerNumber` VARCHAR(50), IN `prReference` VARCHAR(50))
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_cxc_get_report_customer_pay_by_invoice`(IN `prCompanyID` INT, IN `prTokenID` VARCHAR(50), IN `prUserID` INT, IN `prCustomerNumber` VARCHAR(50),IN prInvoiceNumber  VARCHAR(50))
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
  COMMENT 'Lista de Pagos del Cliente'
BEGIN
	...
	#Obtener la inforamcion del cliente 
	select 
		cu.customerNumber,
		CONCAT(nat.firstName,' ' , nat.lastName ) as customerName,
		cu.phoneNumber ,
	...
	#Obtener la lista de fechas de pagos 
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_cxc_get_report_customer_sr_list`(IN `prUserID` INT, IN `prTokenID` VARCHAR(50), IN `prCompanyID` INT, IN `prStartOn` DATETIME, IN `prEndOn` DATETIME)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_cxc_get_report_customer_status`(IN `prCompanyID` INT, IN `prTokenID` VARCHAR(50), IN `prUserID` INT, IN `prCustomerNumber` VARCHAR(50))
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
BEGIN
	...
	FROM
		...
		inner join tb_customer_credit_document ccd on 
			ccl.customerCreditLineID = ccd.customerCreditLineID 
		inner join tb_transaction_master tmx on 
			ccd.documentNumber = tmx.transactionNumber and 
			ccd.companyID = tmx.companyID and 
			ccd.entityID = tmx.entityID 
		inner join tb_currency curx on 
			tmx.currencyID = curx.currencyID 
		inner join tb_customer_credit_amoritization ccda on 
		...
		inner join tb_catalog_item ci6 on 
		...
		inner join tb_workflow_stage ws4 on 
			ccda.statusID = ws4.workflowStageID 			
	where
		e.companyID = prCompanyID and 
		c.customerNumber = prCustomerNumber and 
		ws3.vinculable in (1,0) and 
		(	
			   	((ccd.providerIDCredit = fn_get_provider_id (prCompanyID,prUserID)) and (fn_get_provider_id (prCompanyID,prUserID) != 0))
					or 
					(fn_get_provider_id (prCompanyID,prUserID) = 0 )
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_cxc_get_report_document_contract`(IN `prCompanyID` INT, IN `prTokenID` VARCHAR(50), IN `prUserID` INT, IN `prDocumentNumber` VARCHAR(50))
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_cxc_get_report_document_credit`(IN `prCompanyID` INT, IN `prTokenID` VARCHAR(50), IN `prUserID` INT, IN `prDocumentNumber` VARCHAR(50))
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
BEGIN
	DECLARE exchangeRate_ DECIMAL(18,8) DEFAULT 0;		
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_cxc_get_report_exchange_rate`(IN `prUserID` INT, IN `prTokenID` VARCHAR(50), IN `prCompanyID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
BEGIN
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_cxc_get_report_info_proyect`(IN `prCompanyID` INT, IN `prTokenID` VARCHAR(50), IN `prUserID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
BEGIN
	DECLARE exchangeRate_ DECIMAL(18,8) DEFAULT 0;		
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_cxc_get_report_interes_periodo`(IN `prUserID` INT, IN `prTokenID` VARCHAR(50), IN `prCompanyID` INT, IN `prStartOn` DATETIME, IN `prEndOn` DATETIME)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_cxc_get_report_invoice_by_customer`(IN `prCompanyID` INT, 
...
BEGIN
		...
		where 
			...
			tm.transactionID = 19 /*factura*/ ; 
		
END;

DROP PROCEDURE IF EXISTS `pr_cxc_get_report_movement_customer`;

CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_cxc_get_report_movement_customer`(IN `prCompanyID` INT, IN `prTokenID` VARCHAR(50), IN `prUserID` INT, IN `prCustomerNumber` VARCHAR(50))
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
  COMMENT 'Estado de cuenta del cliente'
BEGIN
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_cxc_get_report_sales_customer`(IN `prCompanyID` INT, IN `prTokenID` VARCHAR(50), IN `prUserID` INT, 
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_cxc_get_report_summary_credit`(IN `prUserID` INT, IN `prTokenID` VARCHAR(250), IN `prCompanyID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
BEGIN
	select 
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_cxc_get_report_upload_buro`(IN `prUserID` INT, IN `prTokenID` VARCHAR(250), IN `prCompanyID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_cxc_proc_expandinvoice`(IN `prCompanyID` INT, IN `prDocumentNumber` VARCHAR(50))
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_cxc_proc_suprime_share`(IN `prCompanyID` INT, IN `prDocumentNumber` VARCHAR(50), IN `prCuotaModificada` DATETIME, IN `prAumentaMesDeGracia` BIT, IN `prCambioInteresDelMes` DECIMAL(19,5))
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_cxp_get_report_expenses_detail`(IN `prCompanyID` INT, IN `prTokenID` VARCHAR(50), IN `prUserID` INT, IN `prStartOn` DATE, IN `prEndOn` DATE , IN prTipoExpense INT , IN prCategoryExpenses INT, IN prClassExpenses INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_cxp_get_report_expenses_summary`(IN `prCompanyID` INT, IN `prTokenID` VARCHAR(50), IN `prUserID` INT,  IN `prStartOn` DATE, IN `prEndOn` DATE , IN prTipoExpense INT , IN prCategoryExpenses INT , IN prClassExpenses INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_cxp_get_report_expenses_summary_pivot`(IN `prCompanyID` INT, IN `prTokenID` VARCHAR(50), IN `prUserID` INT,  IN `prStartOn` DATE, IN `prEndOn` DATE)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_cxp_get_report_purchase_detail`(IN `prCompanyID` INT, IN `prTokenID` VARCHAR(50), IN `prUserID` INT, IN `prStartOn` DATE, IN `prEndOn` DATE,IN prInventoryCategoryID INT, IN prWarehouse INT,
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_inventory_calculate_kardex_new_input`(IN `prCompanyID` INT, IN `prTransactionID` INT, IN `prTransactionMasterID` BIGINT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
BEGIN
	...
	select 
		...
		varTransactionOn,		
		IF(tm.transactionID = 20 /*REVERSION DE FACTURAS*/,tm.skuQuantityBySku,tm.quantity) as tm_quantity, 
		tm.unitaryCost,
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_inventory_calculate_kardex_new_output`(IN `prCompanyID` INT, IN `prTransactionID` INT, IN `prTransactionMasterID` BIGINT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
BEGIN
    ...
    START TRANSACTION;
		...
		select 
			...
			IF(tm.transactionID = 19 /*FACTURAS*/,tm.skuQuantityBySku,tm.quantity) as tm_quantity,
			tm.unitaryCost ,
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_inventory_create_transaction_input_by_ajuste`(IN `prCompanyID` INT, IN `prBranchID` INT, IN `prLoginID` INT, 
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_inventory_create_transaction_otherinput_by_production`(IN `prCompanyID` INT, IN `prBranchID` INT, IN `prLoginID` INT, 
...
BEGIN
			...
			DECLARE varTransactionID int default  12 /*otras entradas*/; 		
			DECLARE varComponentID int default  34; 			
			DECLARE varComponentItemID int default  33; 	
			DECLARE varComponentAccountID int default 4; 	
		  DECLARE minItemID int default 0;
			...
			while minItemID <= maxItemID and minItemID is not null do 				
					...
					VALUES (
						...
						0 /*AMOUNT*/,
						quantityWhile * costWhile  /*COSTO*/, 
						quantityWhile  /*CANTIDAD*/,
						0,
						costWhile /*UNITARIO AMOUNT*/, 
						costWhile /*UNITARIO COSTO*/,
						costWhile /*UNITARIO PRECIO*/,
						0,0,1,0,0,
						0,0,prWarehouseID
					);
			...
			/*actualizar las referencias de la orden de produccion*/
			UPDATE tb_transaction_master set 
							reference1 = 	CASE 
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_inventory_create_transaction_otheroutput_by_production`(IN `prCompanyID` INT, IN `prBranchID` INT, IN `prLoginID` INT, 
	IN `prTransactionID` INT, IN `prTransactionMasterID` INT, 	
	IN prWarehouseID INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
BEGIN
			...
			DECLARE varTransactionID int default  8 /*otras salidas*/; 		
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_inventory_create_transaction_output_by_ajuste`(IN `prCompanyID` INT, IN `prBranchID` INT, IN `prLoginID` INT, 
	IN `prTransactionID` INT, IN `prTransactionMasterID` INT, OUT `prResult` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
BEGIN
				...
				DECLARE varTransactionID int default  19; 		
			...
			CALL pr_core_get_next_number(prCompanyID,'tb_transaction_master_billing',prBranchID,0,varTransactionNumber);		
			CALL pr_core_get_workflow_stage_init (prCompanyID,"tb_transaction_master_billing","statusID",varStatusIDTransactionInit );	
			...
			SET varStatusIDTransactionFinish = (
				...
				where 
					e.`name` = 'statusID' and 
					el.`name` = 'tb_transaction_master_billing' and 
					ws.aplicable = 1 
			);
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_inventory_create_transaction_output_by_formulated`(IN `prCompanyID` INT, IN `prBranchID` INT, IN `prLoginID` INT, IN `prPeriodID` INT, 
...
BEGIN
			...
			WHERE
				...
				ds.isActive = 1 and 
				dsd.isActive = 1 and 
				tmm.transactionOn BETWEEN varFechaStart and varFechaEnd; 
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_inventory_get_eport_list_item_expired`(IN `prUserID` INT, IN `prTokenID` VARCHAR(50), IN `prCompanyID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_inventory_get_report_auxiliar_mov_by_allwarehouse`(IN `prCompanyID` INT, IN `prStartOn` DATETIME, IN `prEndOn` DATETIME, IN `prItemID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_inventory_get_report_auxiliar_mov_by_warehouse`(IN `prCompanyID` INT, IN `prWarehouseID` INT, IN `prStartOn` DATETIME, IN `prEndOn` DATETIME, IN `prItemID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_inventory_get_report_list_item`(IN `prUserID` INT, IN `prTokenID` VARCHAR(50), IN `prCompanyID` INT,IN `prWarehouseID` INT,IN `prCategoryID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
BEGIN
	...
	WHERE
		...
		(
			...
			or 
			(
				w.warehouseID = prWarehouseID and   prWarehouseID != 0  
			)
		) and 
		(
			(
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_inventory_get_report_list_item_by_warehouse`(IN `prUserID` int,IN `prTokenID` varchar(50),IN `prCompanyID` int,IN `prWarehouseID` VARCHAR(150))
BEGIN
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_inventory_get_report_list_item_out_exists`(IN `prUserID` INT, IN `prTokenID` VARCHAR(50), IN `prCompanyID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
  COMMENT 'Lista de Productos'
BEGIN
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_inventory_get_report_list_item_width_exists`(IN `prUserID` INT, IN `prTokenID` VARCHAR(50), IN `prCompanyID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
  COMMENT 'Lista de Productos'
BEGIN
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_inventory_get_report_master_kardex`(IN `prUserID` INT, IN `prTokenID` VARCHAR(50), IN `prCompanyID` INT, IN `prWarehouseID` INT, IN `prStartOn` DATETIME, IN `prEndOn` DATETIME)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_inventory_get_report_purchase`(IN `prUserID` INT, IN `prTokenID` VARCHAR(50), IN `prCompanyID` INT, IN `prWarehouseID` INT, IN `prStartOn` DATETIME, IN `prEndOn` DATETIME, IN prEntityIDProvider INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
  COMMENT 'Procedimiento para obtener el karde de mercaderia'
BEGIN
		...
		WHERE 
			tm.isActive = 1 and 
			tm.transactionID = 21 /*compra*/ and 
			ws.aplicable = 1 and 
			td.isActive = 1 and 
			tm.companyID = prCompanyID and 
			tm.createdOn between prStartOn and prEndOn and 
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_inventory_last_item_movement`(IN `prCompanyID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_inventory_recalculate_cost`(IN `prCompanyID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
  COMMENT 'Recalcular costo de inventario'
BEGIN
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_notification_buy`(IN `prCompanyID` INT, IN `prTokenID` VARCHAR(50), IN `prUserID` INT, IN `prStartOn` DATE, IN `prEndOn` DATE)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
  COMMENT 'Detalle de ventas'
BEGIN
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_planilla_create_transaction`(IN `prCompanyID` INT, IN `prCalendarID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_planilla_remove_adelanto`(IN `prCompanyID` INT, IN `prTransactionID` INT, IN `prTransactionMasterID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_planilla_update_adelanto`(IN `prCompanyID` INT, IN `prTransactionID` INT, IN `prTransactionMasterID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_purchase_get_report_purchase_detail`(IN `prCompanyID` INT, IN `prTokenID` VARCHAR(50), IN `prUserID` INT, IN `prStartOn` DATE, IN `prEndOn` DATE,IN prProviderID INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_purchase_get_report_purchase_taller`(IN `prUserID` int,IN `prTokenID` varchar(50),IN `prCompanyID` int,IN `prEmployerID` varchar(150), IN prStartOn DATETIME, IN prEndOn DATETIME)
BEGIN
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_sales_get_repor_sales_by_reference`(IN `prCompanyID` int,IN `prTokenID` varchar(50),IN `prUserID` int,IN `prStartOn` date,IN `prEndOn` date,IN `prInventoryCategoryID` int,IN `prWarehouse` int)
BEGIN
    ...
    rx.legalName,
		varCurrencyReporte		
ORDER BY rx.employerName, rx.transactionNumber;

END;

DROP PROCEDURE IF EXISTS `pr_sales_get_report_sales_by_client`;

CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_sales_get_report_sales_by_client`(IN `prCompanyID` INT,
	IN `prTokenID` VARCHAR(50),
	IN `prUserID` INT,
	IN `prStartOn` DATE,
	IN `prEndOn` DATE,
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_sales_get_report_sales_comisssion_summary`(IN `prCompanyID` INT, IN `prTokenID` VARCHAR(50), IN `prUserID` INT, IN `prStartOn` DATE, IN `prEndOn` DATE,IN prInventoryCategoryID INT, IN prWarehouse INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
  COMMENT 'Detalle de ventas'
BEGIN
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_sales_get_report_sales_day`(IN `prCompanyID` INT, IN `prTokenID` VARCHAR(50), IN `prUserID` INT, IN `prStartOn` DATETIME, IN `prEndOn` DATETIME)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
  COMMENT 'Detalle de ventas'
BEGIN
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_sales_get_report_sales_detail`(IN `prCompanyID` INT, IN `prTokenID` VARCHAR(50), IN `prUserID` INT, IN `prStartOn` DATE, IN `prEndOn` DATE,IN prInventoryCategoryID INT, IN prWarehouse INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
  COMMENT 'Detalle de ventas'
BEGIN
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_sales_get_report_sales_detail_commission`(IN `prCompanyID` INT, IN `prTokenID` VARCHAR(50), IN `prUserID` INT, IN `prStartOn` DATE, IN `prEndOn` DATE,IN prInventoryCategoryID INT, IN prWarehouse INT, IN prUserIDSales INT, IN prText VARCHAR(50), IN prEmployerID INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
  COMMENT 'Detalle de ventas'
BEGIN
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_sales_get_report_sales_summary`(IN `prCompanyID` INT, IN `prTokenID` VARCHAR(50), IN `prUserID` INT, IN `prStartOn` DATETIME, IN `prEndOn` DATETIME, IN `prUserIDFilter` INT , IN prConceptFilter VARCHAR(150), IN prWithTax1 INT ,IN `prBranchID` INT, IN prWarehouseID INT, IN prEntityIDCustomer INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_sales_get_report_sales_summary_credit`(IN `prCompanyID` INT, IN `prTokenID` VARCHAR(50), IN `prUserID` INT, IN `prStartOn` DATETIME, IN `prEndOn` DATETIME, IN `prUserIDFilter` INT , IN prConceptFilter VARCHAR(150) ,IN `prBranchID` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
  COMMENT 'Resumen de venta'
BEGIN
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_sales_get_report_sales_utility_summary`(IN `prCompanyID` INT, IN `prTokenID` VARCHAR(50), IN `prUserID` INT, IN `prStartOn` DATE, IN `prEndOn` DATE, IN prExpenditureClassification INT, IN prBranchID INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
  COMMENT 'Detalle de ventas'
BEGIN
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_transaction_master_detail`(IN `prCompanyID` int,IN `prTransactionID` int,IN `prTransactionMasterID` int)
BEGIN
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_transaction_report_registradas_anuladas`(IN `prCompanyID` INT, IN `prTokenID` VARCHAR(50), IN `prUserID` INT, IN `prStartOn` DATE, IN `prEndOn` DATE)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_transaction_revert`(IN `prCompanyID` INT, IN `prTransactionIDOriginal` INT, IN `prTransactionMasterIDOriginal` BIGINT, IN `prTransactionIDRevert` INT, IN `prTransactionMasterIDRevert` BIGINT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_zerror_reparar_kardex`(IN `prItemID` INT  , IN prWarehouseID INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_zerror_reparar_tabla_amortization_dias_para_gym_raptor`(IN `prItemID` INT , IN `prDay` INT)
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
...
CREATE DEFINER =  CURRENT_USER  PROCEDURE `pr_zerror_trasladar_todo_a_bodega_despacho`()
  MODIFIES SQL DATA 
  SQL SECURITY INVOKER
