...
/*--Imprimir abonos	*/			
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "app_box_share/viewRegisterFormatoPaginaTicketRepuestoCristoRey" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "app_invoice_billing/viewRegisterFormatoPaginaNormal80mmOpcion1RepuestoCristoRey" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Samara" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "0010710890040H" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
