...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "flc_variedades_salm" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "POS-80-Series USB" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "2024-01-06" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Briseyda del Carmen Salmeron Vargas" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "briseyda_salmeron@yahoo.es" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "J0310000430322" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
	tb_parameter.name = "CORE_PROPIETARY_ID";## CEDULA DEL PROPIETARIO 291-081197-0001Y
...
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
	tb_parameter.name = "CORE_COMPANY_IDENTIFIER";## RUC 291-081197-0001Y
				
				
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "CLARO. 8839-2494" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Costado sur de iglesia catolica, Malpaisillo" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE tb_company SET 
	NAME = 'Variedades Salmeron' , address = 'Costado sur de iglesia catolica, Malpaisillo' 
WHERE 
