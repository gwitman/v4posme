...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Eveling del Rosario Espinoza Delgado" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "2810805870002R" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "TEL: 8370-9267" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Alcaldia 1C al este 10 metros al sur." 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE tb_company SET 
	NAME = 'Tendencias de Moda Eve #3' , address = 'Alcaldia 1C al este 10 metros al sur.' ,
	flavorID = 448,type='default'
WHERE 
