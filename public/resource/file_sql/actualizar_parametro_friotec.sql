/*BD: 	db9bhcmbb7hzo4:parametro_FrioTec*/
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Carlos Alberto Sanchez Lacayo" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "2812404840014Y" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "TEL: 8969-0433" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
