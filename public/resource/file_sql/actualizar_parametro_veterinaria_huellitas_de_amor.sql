...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "flc_veterianaria_huellas_de_amor" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
	tb_parameter.name = "INVOICE_HIDEN_ITEMNUMBER_IN_POPUP";#Ocultar el codigo del sistema en el pupoup de seleccion de producto
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "80.00" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Darling Sujey Delgada Hubeda" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "mdarlingsujey@hotmail.com" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "243-250476-0005Y IPSA:1794" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "TEL: 8204-6600" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Semaforos de enabas 1c al oeste." 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE tb_company SET 
	NAME = 'Veterinaria Huellitas de Amor' , address = 'Semaforos de enabas 1c al oeste.' ,
	flavorID = 0 
WHERE 
