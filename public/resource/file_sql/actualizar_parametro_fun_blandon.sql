...
/*--Imprimir abonos	*/			
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "app_box_share/viewRegisterFormatoPaginaTicketFunBlandon" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "app_invoice_billing/viewRegisterFormatoPaginaNormalA4FunBlandonReciboOficialCaja" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
