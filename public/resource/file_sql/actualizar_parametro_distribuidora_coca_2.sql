/*BD: 	db0snegzygg7rk :parametro_distribudora_coca_2*/
...
WHERE 
	...
	tb_parameter.name = "MOBILE_URL_VIEW_REPORT_REMOTE";## Url para ver los reportes remotos en el mobile	
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Mauricio Alberto Vargas Alvarez" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "8163-9981 ó  5757-4079" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Vista del momotombo B18-C10" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE tb_company SET 
	NAME = 'Distribuidora Coca #2' , address = 'Vista del momotombo B18-C10' ,
	flavorID = 1256 /*usuarioID*/,type='distCoca2'  , abreviature='demo'
WHERE 
