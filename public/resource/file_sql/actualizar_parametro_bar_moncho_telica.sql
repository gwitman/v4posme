/*BD: 	dbigoery0ji5qa:parametro_moncho*/
/*SERVIDOR:		siteground*/
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Juan Gomez" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "juangomez280487@gmail.com" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "2812408870000B" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "8141-6555" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Claro 1 cuadra al Norte, 1.5 cuadra al este." 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE tb_company SET 
	NAME = 'Moncho,s Bar' , address = 'Claro 1 cuadra al Norte, 1.5 cuadra al este.' ,
	flavorID = 1031 /*usuarioID*/,type='moncho'  , abreviature='demo'
WHERE 
