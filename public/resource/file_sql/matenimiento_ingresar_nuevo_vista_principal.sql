...
set @viewName := 'LISTA DE EXAMENES';
set @componentName := 'tb_transaction_master_examen_lab';
...
select 
	...
	substring(nat.firstName,1,15) as Cliente ,
	ct.name as Tipo
from 
...
set @viewColumnVisible := 'Numero,Fecha,Estado,Usuario,Cliente,Tipo';
