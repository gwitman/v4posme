/*BD: 	dbus0yksjhipwq:parametro_benitex*/
/*SERVIDOR:		siteground*/
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "081100860005A" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "8168-0852 TEL. 8554-8260" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Costado oeste donde fue desmontadora La Virgen, El Viejo." 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE tb_company SET 
	NAME = 'Benitex Steak House' , address = 'Costado oeste donde fue desmontadora La Virgen, El Viejo.' ,
