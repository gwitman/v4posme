...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Inversiones Inmobiliarias Santa Lucia S.A" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "operaciones@staluciarealestate.com" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "J0310000437530" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "TEL: 8513-8974" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Km 9.8 Carretera a Masaya, Oficentro Metropolitano 1 piso, Modulo N.4" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE tb_company SET 
	NAME = 'Santa Lucia Real State' , address = 'Km 9.8 Carretera a Masaya, Oficentro Metropolitano 1 piso, Modulo N.4' ,
