...
WHERE 
	...
	tb_parameter.name = "CXC_COUNT_MAX_REQUEST_BURO";## Maximas consultas al buro de credito
...
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
	tb_parameter.name = "CXC_CURRENT_REQUEST_BURO";## Cantidad de consulas al buro de credito
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "flc_credi_confianza" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "2024-08-03" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "50558790686" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "TEL: 5879-0686" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "De los semasforo rafael herrera 20v.s" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE tb_company SET 
	NAME = 'Credi Confianza' , address = 'De los semasforo rafael herrera 20v.s' ,
	flavorID = 0 
WHERE 
