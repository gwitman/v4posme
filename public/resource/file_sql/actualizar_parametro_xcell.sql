...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Exson Emilio Mendoza Martinez" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "610-291001-1004X" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "TEL: 7523-0236" 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE  tb_company_parameter,tb_parameter SET 
	tb_company_parameter.value = "Contiguo a la Western Union." 
WHERE 
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
...
UPDATE tb_company SET 
	NAME = 'XCELL' , address = 'Contiguo a la Western Union.' ,
	flavorID = 945 /*usuarioID*/,type='xcell'  , abreviature='demo'
WHERE 
